...
<template>
  <s-layout :title="t('goodsCollect')">
    ...
    <uni-load-more
      ...
      @tap="loadMore"
    />
    <s-empty v-if="state.pagination.total === 0" :text="t('noCollect')" icon="/static/collect-empty.png" />
  </s-layout>
</template>
