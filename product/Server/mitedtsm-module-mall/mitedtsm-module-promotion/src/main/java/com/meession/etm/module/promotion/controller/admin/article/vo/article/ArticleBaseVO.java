package com.meession.etm.module.promotion.controller.admin.article.vo.article;
...
public class ArticleBaseVO {
    ...
    @Schema(description = "文章封面图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
