package com.meession.etm.module.promotion.controller.admin.bargain.vo.recrod;
...
public class BargainRecordPageItemRespVO extends BargainRecordBaseVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
