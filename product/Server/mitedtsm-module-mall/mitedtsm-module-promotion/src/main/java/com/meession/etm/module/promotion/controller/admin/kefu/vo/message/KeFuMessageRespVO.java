package com.meession.etm.module.promotion.controller.admin.kefu.vo.message;
...
public class KeFuMessageRespVO {
    ...
    @Schema(description = "发送人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://mitedtsm.com/images/avatar.jpg")
