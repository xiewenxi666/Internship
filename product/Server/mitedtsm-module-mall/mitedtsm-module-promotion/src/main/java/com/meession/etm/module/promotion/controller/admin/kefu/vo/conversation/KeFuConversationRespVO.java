package com.meession.etm.module.promotion.controller.admin.kefu.vo.conversation;
...
public class KeFuConversationRespVO {
    ...
    private Long userId;
    @Schema(description = "会话所属用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://mitedtsm.com/images/avatar.jpg")
    private String userAvatar;
    @Schema(description = "会话所属用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
