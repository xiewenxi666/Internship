package com.meession.etm.module.promotion.controller.admin.combination.vo.recrod;
...
public class CombinationRecordBaseVO {
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
