...
import com.meession.etm.module.pay.enums.DictTypeConstants;
import com.meession.etm.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.meession.etm.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.meession.etm.module.product.api.sku.dto.ProductSkuRespDTO;
import com.meession.etm.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.meession.etm.module.product.api.spu.dto.ProductSpuRespDTO;
import com.meession.etm.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.meession.etm.module.trade.api.order.dto.TradeOrderRespDTO;
import com.meession.etm.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.meession.etm.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.meession.etm.module.trade.controller.admin.order.vo.*;
import com.meession.etm.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.meession.etm.module.trade.controller.app.order.vo.*;
import com.meession.etm.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.meession.etm.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.meession.etm.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.meession.etm.module.trade.framework.order.config.TradeOrderProperties;
import com.meession.etm.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/mitedtsmcode/mitedtsm-mall-uniapp/issues/ICY7SJ
