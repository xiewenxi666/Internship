package com.meession.etm.module.trade.controller.admin.config;
...
import com.meession.etm.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${mitedtsm.tencent-lbs-key}")
