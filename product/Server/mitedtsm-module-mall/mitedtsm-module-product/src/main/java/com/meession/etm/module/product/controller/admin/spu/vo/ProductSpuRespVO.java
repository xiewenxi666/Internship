package com.meession.etm.module.product.controller.admin.spu.vo;
...
import com.meession.etm.framework.excel.core.convert.MoneyConvert;
import com.meession.etm.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[xxx, xxx]")
