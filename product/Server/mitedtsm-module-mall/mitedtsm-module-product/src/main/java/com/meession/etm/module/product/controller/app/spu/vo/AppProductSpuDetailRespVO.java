package com.meession.etm.module.product.controller.app.spu.vo;

import com.meession.etm.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
    private String name;
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
        private String picUrl;
