...
public interface ErrorCodeConstants {
    ...
    // ========== 订单管理 1_020_019_000 ==========
    ErrorCode ORDER_NOT_EXISTS = new ErrorCode(1_020_019_000, "订单不存在");
    ErrorCode ORDER_NO_EXISTS = new ErrorCode(1_020_019_001, "生成订单序列号重复，请重试");
    ErrorCode ORDER_UPDATE_FAIL = new ErrorCode(1_020_019_002, "更新订单失败，原因：订单不是草稿或提交状态");
    ErrorCode ORDER_DELETE_FAIL = new ErrorCode(1_020_019_003, "删除订单失败，原因：订单不是草稿、已拒绝或已取消状态");
    ErrorCode ORDER_WITHDRAW_FAIL_NOT_APPROVING = new ErrorCode(1_020_019_004, "撤回订单审批失败，原因：订单不是审批中状态");
    ErrorCode ORDER_SUBMIT_FAIL_NOT_DRAFT = new ErrorCode(1_020_019_005, "提交订单审批失败，原因：订单不是草稿状态");
    ErrorCode ORDER_UPDATE_AUDIT_STATUS_FAIL_NOT_PROCESS = new ErrorCode(1_020_019_006, "更新订单审核状态失败，原因：订单不是审核中状态");
    ErrorCode ORDER_TRANSFER_FAIL = new ErrorCode(1_020_019_007, "转移订单负责人失败，原因：转移对象已经是该负责人");
    ErrorCode ORDER_UPDATE_STATUS_FAIL = new ErrorCode(1_020_019_008, "更新订单状态失败");
