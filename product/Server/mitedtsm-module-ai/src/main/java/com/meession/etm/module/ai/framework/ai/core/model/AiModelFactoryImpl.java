package com.meession.etm.module.ai.framework.ai.core.model;
...
import com.meession.etm.framework.common.util.spring.SpringUtils;
import com.meession.etm.module.ai.enums.model.AiPlatformEnum;
import com.meession.etm.module.ai.framework.ai.config.AiAutoConfiguration;
import com.meession.etm.module.ai.framework.ai.config.MitedtsmAiProperties;
...
import com.meession.etm.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.meession.etm.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            MitedtsmAiProperties.Midjourney properties = SpringUtil.getBean(MitedtsmAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(MitedtsmAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        MitedtsmAiProperties.DouBao properties = new MitedtsmAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(MitedtsmAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        MitedtsmAiProperties.HunYuan properties = new MitedtsmAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(MitedtsmAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        MitedtsmAiProperties.SiliconFlow properties = new MitedtsmAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(MitedtsmAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        MitedtsmAiProperties.XingHuo properties = new MitedtsmAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(MitedtsmAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        MitedtsmAiProperties.BaiChuan properties = new MitedtsmAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(MitedtsmAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        MitedtsmAiProperties.Gemini properties = SpringUtil.getBean(MitedtsmAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        MitedtsmAiProperties.Grok properties = new MitedtsmAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
