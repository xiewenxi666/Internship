package com.meession.etm.module.ai.service.chat;
...
import com.meession.etm.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.meession.etm.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.meession.etm.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.meession.etm.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.meession.etm.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.meession.etm.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.meession.etm.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.meession.etm.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.meession.etm.module.ai.dal.dataobject.model.AiModelDO;
import com.meession.etm.module.ai.dal.dataobject.model.AiToolDO;
import com.meession.etm.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.meession.etm.module.ai.enums.ErrorCodeConstants;
import com.meession.etm.module.ai.enums.model.AiPlatformEnum;
import com.meession.etm.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.meession.etm.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.meession.etm.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.meession.etm.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.meession.etm.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.meession.etm.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.meession.etm.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.meession.etm.module.ai.service.model.AiChatRoleService;
import com.meession.etm.module.ai.service.model.AiModelService;
import com.meession.etm.module.ai.service.model.AiToolService;
import com.meession.etm.module.ai.util.AiUtils;
import com.meession.etm.module.ai.util.FileTypeUtils;
...
import static com.meession.etm.framework.common.pojo.CommonResult.error;
...
import static com.meession.etm.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.meession.etm.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 mitedtsm.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 mitedtsm.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
