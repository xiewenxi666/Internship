package com.meession.etm.module.erp.controller.admin.purchase.vo.returns;
...
public class ErpPurchaseReturnRespVO {
    ...
    @Schema(description = "供应商名称", example = "密讯")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "密讯")
    private String creator;
    @Schema(description = "创建人名称", example = "密讯")
