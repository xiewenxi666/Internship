...
import com.meession.etm.framework.common.util.collection.ArrayUtils;
...
import com.meession.etm.module.infra.api.config.ConfigApi;
import com.meession.etm.module.infra.api.file.FileApi;
import com.meession.etm.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.meession.etm.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.meession.etm.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.meession.etm.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.meession.etm.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.meession.etm.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.meession.etm.module.system.dal.dataobject.dept.UserPostDO;
import com.meession.etm.module.system.dal.dataobject.tenant.TenantDO;
import com.meession.etm.module.system.dal.dataobject.user.AdminUserDO;
import com.meession.etm.module.system.dal.mysql.dept.UserPostMapper;
import com.meession.etm.module.system.dal.mysql.user.AdminUserMapper;
import com.meession.etm.module.system.enums.common.SexEnum;
...
import com.meession.etm.module.system.service.oauth2.OAuth2TokenService;
import com.meession.etm.module.system.service.permission.PermissionService;
import com.meession.etm.module.system.service.tenant.TenantService;
...
import static com.meession.etm.framework.common.util.collection.SetUtils.asSet;
...
import static com.meession.etm.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("mitedtsmyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("mitedtsmyuanma");
        ...
        assertEquals("mitedtsmyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("mitedtsmyuanma"))).thenReturn("java");
