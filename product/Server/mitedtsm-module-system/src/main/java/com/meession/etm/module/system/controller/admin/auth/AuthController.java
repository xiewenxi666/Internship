package com.meession.etm.module.system.controller.admin.auth;
...
import com.meession.etm.framework.security.config.SecurityProperties;
...
import com.meession.etm.module.system.dal.dataobject.permission.MenuDO;
...
import com.meession.etm.module.system.service.auth.AdminAuthService;
import com.meession.etm.module.system.service.permission.MenuI18nService;
import com.meession.etm.module.system.service.permission.MenuService;
...
import com.meession.etm.module.system.service.social.SocialClientService;
...
public class AuthController {
    ...
    @Resource
    private MenuI18nService menuI18nService;
    @Resource
    ...
    public CommonResult<AuthPermissionInfoRespVO> getPermissionInfo() {
        ...
        if (!"zh_CN".equals(language) && CollUtil.isNotEmpty(menuList)) {
            // 获取所有菜单的国际化名称
            Map<Long, String> menuNameMap = menuI18nService.getMenuNameMap(
                    menuList.stream().map(MenuDO::getId).collect(Collectors.toList()), language);
            // 替换菜单名称
            menuList.forEach(menu -> {
                String i18nName = menuNameMap.get(menu.getId());
                if (i18nName != null) {
                    menu.setName(i18nName);
                }
            });
        }
