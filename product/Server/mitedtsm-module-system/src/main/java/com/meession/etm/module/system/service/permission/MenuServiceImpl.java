...
import com.meession.etm.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.meession.etm.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.meession.etm.module.system.dal.dataobject.permission.MenuDO;
import com.meession.etm.module.system.dal.mysql.permission.MenuMapper;
import com.meession.etm.module.system.dal.redis.RedisKeyConstants;
import com.meession.etm.module.system.enums.permission.MenuTypeEnum;
...
public class MenuServiceImpl implements MenuService {
    ...
    public Long createMenu(MenuSaveVO createReqVO) {
        ...
        // 保存国际化数据
        if (createReqVO.getI18nList() != null && !createReqVO.getI18nList().isEmpty()) {
            menuI18nService.saveMenuI18n(menu.getId(), createReqVO.getI18nList());
        }
    ...
    public void updateMenu(MenuSaveVO updateReqVO) {
        ...
        // 更新国际化数据
        menuI18nService.saveMenuI18n(updateReqVO.getId(), updateReqVO.getI18nList());
    }
    ...
    public void deleteMenu(Long id) {
        ...
        // 删除国际化数据
        menuI18nService.deleteMenuI18n(id);
    }
    ...
    public void deleteMenuList(List<Long> ids) {
        ...
        // 删除国际化数据
        ids.forEach(id -> menuI18nService.deleteMenuI18n(id));
    }
