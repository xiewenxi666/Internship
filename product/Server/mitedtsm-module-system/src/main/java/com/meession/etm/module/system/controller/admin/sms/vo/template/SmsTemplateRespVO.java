package com.meession.etm.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "mitedtsm")
    @ExcelProperty("模板名称")
    private String name;
