package com.meession.etm.module.system.service.tenant;
...
import com.meession.etm.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.meession.etm.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.meession.etm.module.system.convert.tenant.TenantConvert;
...
import com.meession.etm.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.meession.etm.module.system.dal.mysql.tenant.TenantMapper;
...
import com.meession.etm.module.system.service.tenant.handler.TenantInfoHandler;
import com.meession.etm.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 mitedtsm.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
