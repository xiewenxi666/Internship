package com.meession.etm.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.meession.etm.framework.common.enums.RpcConstants;
...
import com.meession.etm.module.iot.core.biz.dto.*;
...
import com.meession.etm.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 mitedtsm-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
