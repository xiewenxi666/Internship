package com.meession.etm.module.iot.dal.dataobject.device;
...
public class IotDeviceMessageDO {
     ...
     * 是否上行消息
     *
     * 由 {@link com.meession.etm.module.iot.core.util.IotDeviceMessageUtils#isUpstreamMessage(IotDeviceMessage)} 计算。
     ...
     * 是否回复消息
     *
     * 由 {@link com.meession.etm.module.iot.core.util.IotDeviceMessageUtils#isReplyMessage(IotDeviceMessage)} 计算。
