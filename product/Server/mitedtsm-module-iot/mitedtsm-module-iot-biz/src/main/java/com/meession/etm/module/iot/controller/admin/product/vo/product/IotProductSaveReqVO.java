package com.meession.etm.module.iot.controller.admin.product.vo.product;
...
import com.meession.etm.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "产品图标", example = "xxx")
    private String icon;

    @Schema(description = "产品图片", example = "xxx")
