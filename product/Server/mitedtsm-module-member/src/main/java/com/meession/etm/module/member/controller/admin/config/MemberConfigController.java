package com.meession.etm.module.member.controller.admin.config;

import com.meession.etm.framework.common.pojo.CommonResult;
import com.meession.etm.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.meession.etm.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.meession.etm.module.member.convert.config.MemberConfigConvert;
import com.meession.etm.module.member.dal.dataobject.config.MemberConfigDO;
import com.meession.etm.module.member.service.config.MemberConfigService;
