...
import com.meession.etm.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.meession.etm.module.infra.dal.mysql.file.FileConfigMapper;
import com.meession.etm.module.infra.framework.file.core.client.FileClient;
import com.meession.etm.module.infra.framework.file.core.client.FileClientConfig;
import com.meession.etm.module.infra.framework.file.core.client.FileClientFactory;
import com.meession.etm.module.infra.framework.file.core.client.local.LocalFileClient;
import com.meession.etm.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.meession.etm.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.meession.etm.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.meession.etm.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        assertEquals("xxx", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("xxx")));
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("密讯")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("xxx");

        // 调用，并断言
        assertEquals("xxx", fileConfigService.testFileConfig(id));
    }
