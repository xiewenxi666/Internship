package com.meession.etm.module.infra.controller.admin.codegen;
...
import com.meession.etm.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.meession.etm.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.meession.etm.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.meession.etm.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.meession.etm.module.infra.convert.codegen.CodegenConvert;
...
import com.meession.etm.module.infra.service.codegen.CodegenService;
...
import static com.meession.etm.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.meession.etm.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "mitedtsm"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "密讯")
    })
