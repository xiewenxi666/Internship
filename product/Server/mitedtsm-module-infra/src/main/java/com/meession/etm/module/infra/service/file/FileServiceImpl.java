...
import com.meession.etm.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import com.meession.etm.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import com.meession.etm.module.infra.controller.admin.file.vo.file.FilePresignedUrlRespVO;
import com.meession.etm.module.infra.dal.dataobject.file.FileDO;
import com.meession.etm.module.infra.dal.mysql.file.FileMapper;
...
import static com.meession.etm.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public InputStream getFileContentStream(Long configId, String path) throws Exception {
        FileClient client = fileConfigService.getFileClient(configId);
        Assert.notNull(client, "客户端({}) 不能为空", configId);
        return client.getContentStream(path);
    }
