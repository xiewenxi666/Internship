package com.meession.etm.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import com.meession.etm.framework.common.pojo.PageResult;
import com.meession.etm.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.meession.etm.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.meession.etm.module.mp.convert.message.MpMessageConvert;
import com.meession.etm.module.mp.dal.dataobject.account.MpAccountDO;
import com.meession.etm.module.mp.dal.dataobject.message.MpMessageDO;
import com.meession.etm.module.mp.dal.dataobject.user.MpUserDO;
import com.meession.etm.module.mp.dal.mysql.message.MpMessageMapper;
import com.meession.etm.module.mp.enums.message.MpMessageSendFromEnum;
import com.meession.etm.module.mp.framework.mp.core.MpServiceFactory;
import com.meession.etm.module.mp.framework.mp.core.util.MpUtils;
import com.meession.etm.module.mp.service.account.MpAccountService;
import com.meession.etm.module.mp.service.material.MpMaterialService;
import com.meession.etm.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.meession.etm.module.mp.service.user.MpUserService;
...
import static com.meession.etm.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
