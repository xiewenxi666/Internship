package com.meession.etm.module.pay.framework.pay.core.client.impl.weixin;
...
import com.meession.etm.framework.common.util.io.FileUtils;
...
import static com.meession.etm.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.meession.etm.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/mitedtsmcode/mitedtsm-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/mitedtsm-cloud/issues/ICSFL6
