package com.meession.etm.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.meession.etm.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
