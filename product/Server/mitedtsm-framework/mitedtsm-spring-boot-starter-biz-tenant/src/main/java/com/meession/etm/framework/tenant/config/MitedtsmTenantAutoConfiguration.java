package com.meession.etm.framework.tenant.config;
...
import com.meession.etm.framework.redis.config.MitedtsmCacheProperties;
...
import com.meession.etm.framework.tenant.core.aop.TenantIgnoreAspect;
import com.meession.etm.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.meession.etm.framework.tenant.core.job.TenantJobAspect;
import com.meession.etm.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.meession.etm.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.meession.etm.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.meession.etm.framework.tenant.core.redis.TenantRedisCacheManager;
import com.meession.etm.framework.tenant.core.security.TenantSecurityWebFilter;
import com.meession.etm.framework.tenant.core.service.TenantFrameworkService;
import com.meession.etm.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.meession.etm.framework.tenant.core.web.TenantContextWebFilter;
import com.meession.etm.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "mitedtsm.tenant", value = "enable", matchIfMissing = true) // 允许使用 mitedtsm.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class MitedtsmTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     MitedtsmCacheProperties mitedtsmCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(mitedtsmCacheProperties.getRedisScanBatchSize()));
