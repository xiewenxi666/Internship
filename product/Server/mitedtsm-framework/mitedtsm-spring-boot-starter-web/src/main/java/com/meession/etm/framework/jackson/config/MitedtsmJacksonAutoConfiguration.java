package com.meession.etm.framework.jackson.config;

import com.meession.etm.framework.common.util.json.JsonUtils;
import com.meession.etm.framework.common.util.json.databind.NumberSerializer;
import com.meession.etm.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.meession.etm.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class MitedtsmJacksonAutoConfiguration {
