package com.meession.etm.framework.common.util.date;
...
public class LocalDateTimeUtils {
    ...
    public static LocalDateTime addTime(Duration duration) {
        return LocalDateTime.now().plus(duration).withNano(0);
    }

    public static LocalDateTime minusTime(Duration duration) {
        return LocalDateTime.now().minus(duration).withNano(0);
    }
