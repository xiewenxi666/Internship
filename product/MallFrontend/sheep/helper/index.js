...
function timeFrom(timestamp = null, format = 'yyyy-mm-dd') {
  ...
  switch (true) {
    case timer < 300:
      tips = t('common.justNow');
      break;
    case timer >= 300 && timer < 3600:
      tips = t('common.minutesAgo', { n: parseInt(timer / 60) });
      break;
    case timer >= 3600 && timer < 86400:
      tips = t('common.hoursAgo', { n: parseInt(timer / 3600) });
      break;
    case timer >= 86400 && timer < 2592000:
      tips = t('common.daysAgo', { n: parseInt(timer / 86400) });
      break;
    default:
      // 如果format为false，则无论什么时间戳，都显示xx之前
      if (format === false) {
        if (timer >= 2592000 && timer < 365 * 86400) {
          tips = t('common.monthsAgo', { n: parseInt(timer / (86400 * 30)) });
        } else {
          tips = t('common.yearsAgo', { n: parseInt(timer / (86400 * 365)) });
        }
      } else {
