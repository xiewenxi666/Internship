      ...
      <view class="ui-tabbar ss-flex ss-col-center ss-row-between">
        ...
        >
          <block v-if="modelValue.favorite">
            <image
              ...
              mode="aspectFit"
            />
            <view class="item-title">{{ t('collected') }}</view>
          </block>
          <block v-else>
            <image
              class="item-icon"
              ...
              mode="aspectFit"
            />
            <view class="item-title">{{ t('collect') }}</view>
          </block>
        </view>
        <view
          v-if="serviceIcon"
        ...
        >
          <image
            ...
            mode="aspectFit"
          />
          <view class="item-title">{{ t('customerService') }}</view>
        </view>
        <view
          v-if="shareIcon"
          class="detail-tabbar-item ss-flex ss-flex-col ss-row-center ss-col-center"
        ...
        >
          <image
            ...
            mode="aspectFit"
          />
          <view class="item-title">{{ t('share') }}</view>
        </view>
        <slot></slot>
      </view>
    </view>
...
<script setup>
  ...
  async function onFavorite() {
    ...
    if (props.modelValue.favorite) {
      ...
      sheep.$helper.toast(t('cancelCollect', {}, 'common'));
    ...
    // 情况二：添加收藏
      ...
      sheep.$helper.toast(t('collectSuccess', {}, 'common'));
