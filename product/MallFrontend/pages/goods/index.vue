  ...
  <view>
    <s-layout :onShareAppMessage="shareInfo" navbar="goods">
      ...
      <s-empty
        ...
        :text="t('goodsNotExist')"
        icon="/static/soldout-empty.png"
        showAction
        :actionText="t('browseMore')"
      ...
      <block v-else>
            ...
            <view class="discountCont">
              <view class="disContT">
                <view class="disContT1">
                  ...
                  <view class="disContT1End">
                    {{ t('directDrop') }} {{ fen2yuan(state.settlementSku.price - state.settlementSku.promotionPrice, false) }}
                  </view>
                </view>
              ...
              <view class="disContB">
                <view class="disContB1">
                  {{ t('priceLabel') }}：{{ fen2yuan(state.settlementSku.price) }} 丨 {{ t('remaining') }}：
          ...
          <view class="title-card detail-card ss-p-y-30 ss-p-x-20">
            ...
            <view class="discounts-box ss-flex ss-row-between ss-m-b-28">
              ...
              <view
                ...
                @tap="onOpenActivity"
              >
                [{{ t('coupon') }}]{{ t('full') }}{{ fen2yuanSimple(coupon.usePrice) }}{{
                  coupon.discountType === 1
                    ? t('yuanOff') + fen2yuanSimple(coupon.discountPrice)
                    : formatDiscountPercent(coupon.discountPercent) + t('discount')
                }}
              </view>
              <!-- 查看满减送的描述 -->
              ...
              >
                <view class="discounts-title ss-m-r-8">{{ t('getCoupon') }}</view>
        ...
        <detail-tabbar v-model="state.goodsInfo">
          ...
          <view class="buy-box ss-flex ss-col-center ss-p-r-20" v-else>
            <button class="ss-reset-button disabled-btn" disabled> {{ t('soldOut') }} </button>
          </view>
        </detail-tabbar>
...
<script setup>
  ...
  onReady(() => {
    setPageTitle('pages/goods/index');
  });
  ...
  function onAddCart(e) {
    if (!e.id) {
      sheep.$helper.toast(t('specRequired'));
      return;
    }
