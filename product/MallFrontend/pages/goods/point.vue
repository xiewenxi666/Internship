      ...
      <view class="detail-swiper-selector">
        ...
        <view class="title-card detail-card ss-p-y-40 ss-p-x-20">
          <view class="ss-flex ss-row-between ss-col-center ss-m-b-18">
            <view class="price-box ss-flex ss-col-bottom">
              ...
              <text class="point-text ss-m-r-16">
                {{ getShowPrice.point }}
                {{
                  !getShowPrice.price || getShowPrice.price === 0 ? '' : `+${getShowPrice.price} ${getCurrencyCode()}`
                }}
              </text>
            </view>
          ...
          <view class="origin-price-text ss-m-b-60" v-if="state.goodsInfo.marketPrice">
            {{ t('originalPrice') }}：{{ fen2yuan(state.selectedSku.marketPrice || state.goodsInfo.marketPrice) }}
          </view>
      ...
      <detail-tabbar v-model="state.goodsInfo">
        <view class="buy-box ss-flex ss-col-center ss-p-r-20">
          ...
          >
            ...
            <view v-else>{{ t('pointExchange') }}</view>
          </button>
        </view>
      </detail-tabbar>
    </block>
...
<script setup>
  ...
  onReady(() => {
    setPageTitle('pages/goods/point');
  });
