...
<template>
  ...
  >
    <view class="notice-box">
      ...
      <view class="notice-title"> {{ t('noDistributionPermission') }} </view>
      <view class="notice-detail"> {{ t('featureNotAvailable') }} </view>
      <button
      ...
      <button class="ss-reset-button back-btn" @tap="sheep.$router.back()"> {{ t('back') }} </button>
    </view>
  </su-popup>
</template>
