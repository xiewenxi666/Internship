<!-- 表达式选择 -->
<template>
  <Dialog :title="t('designer.pleaseSelectExpression')" v-model="dialogVisible" width="1024px">
    <ContentWrap>
      <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" :table-layout="'auto'">
        ...
        <el-table-column :label="t('designer.expression')" align="center" prop="expression" />
