<template>
  <el-form label-width="120px">
    <el-form-item :label="t('designer.ruleType')" prop="candidateStrategy">
      <el-select
    ...
    <el-form-item
      ...
      :label="t('designer.assignUserGroup')"
      prop="candidateParam"
    >
      <el-select
        v-model="userTaskForm.candidateParam"
    ...
    <el-form-item
      ...
      :label="t('designer.formUserField')"
      prop="formUser"
    >
      <el-select
        v-model="userTaskForm.candidateParam"
    ...
    <el-form-item
      ...
      :label="t('designer.formDeptField')"
      prop="formDept"
    >
      <el-select
        v-model="userTaskForm.candidateParam"
    ...
    >
      ...
      <XButton
        ...
        type="success"
        preIcon="ep:select"
        :title="t('designer.selectExpression')"
        size="small"
    ...
    <el-form-item :label="t('designer.skipExpression')" prop="skipExpression">
      <el-input
        type="textarea"
...
const deptLevelLabel = computed(() => {
  let label = t('designer.deptLeaderSource')
  if (userTaskForm.value.candidateStrategy == CandidateStrategy.MULTI_LEVEL_DEPT_LEADER) {
    label = label + t('designer.deptLeaderFromAssigned')
  } else if (userTaskForm.value.candidateStrategy == CandidateStrategy.FORM_DEPT_LEADER) {
    label = label + t('designer.deptLeaderFromForm')
  } else {
    label = label + t('designer.deptLeaderFromInitiator')
  }
  return label
})
