<template>
  <div>
    <el-form-item :label="t('designer.executeType')" key="executeType">
      <el-select v-model="serviceTaskForm.executeType" @change="handleExecuteTypeChange">
        <el-option :label="t('designer.javaClass')" value="class" />
        <el-option :label="t('designer.expression')" value="expression" />
        <el-option :label="t('designer.delegateExpression')" value="delegateExpression" />
        <el-option :label="t('designer.httpRequest')" value="http" />
      </el-select>
    </el-form-item>
    <el-form-item
    ...
    <template v-if="serviceTaskForm.executeType === 'http'">
      <el-form-item :label="t('designer.requestMethod')" key="http-method">
      ...
      <el-form-item :label="t('designer.requestUrl')" key="http-url" prop="requestUrl">
        <el-input v-model="httpTaskForm.requestUrl" clearable />
      </el-form-item>
      <el-form-item :label="t('designer.requestHeaders')" key="http-headers">
        <div style="display: flex; gap: 8px; align-items: flex-start; width: 100%">
          <el-input
            ...
            readonly
            :placeholder="t('designer.clickEditToAddHeaders')"
      ...
      <el-form-item :label="t('designer.disallowRedirects')" key="http-disallow-redirects">
        <el-switch v-model="httpTaskForm.disallowRedirects" />
      </el-form-item>
      <el-form-item :label="t('designer.ignoreException')" key="http-ignore-exception">
        <el-switch v-model="httpTaskForm.ignoreException" />
      </el-form-item>
      <el-form-item :label="t('designer.saveResponseParameters')" key="http-save-response">
        <el-switch v-model="httpTaskForm.saveResponseParameters" />
      </el-form-item>
      <el-form-item :label="t('designer.saveResponseTransient')" key="http-save-transient">
        <el-switch v-model="httpTaskForm.saveResponseParametersTransient" />
      </el-form-item>
      <el-form-item :label="t('designer.resultVariablePrefix')" key="http-result-variable-prefix">
        <el-input v-model="httpTaskForm.resultVariablePrefix" />
      </el-form-item>
      <el-form-item :label="t('designer.saveResponseAsJson')" key="http-save-json">
