<template>
  <div class="panel-tab__content">
    <el-form :model="flowConditionForm" label-width="90px" size="small">
      <el-form-item :label="t('designer.flowType')">
        <el-select v-model="flowConditionForm.type" @change="updateFlowType">
          <el-option :label="t('designer.normalFlow')" value="normal" />
          <el-option :label="t('designer.defaultFlow')" value="default" />
          <el-option :label="t('designer.conditionFlow')" value="condition" />
        </el-select>
      </el-form-item>
      <el-form-item :label="t('designer.conditionFormat')" v-if="flowConditionForm.type === 'condition'" key="condition">
        <el-select v-model="flowConditionForm.conditionType">
          <el-option :label="t('designer.expression')" value="expression" />
          <el-option :label="t('designer.scriptType')" value="script" />
        </el-select>
      </el-form-item>
      <el-form-item
      ...
      >
        <el-form-item :label="t('designer.scriptLanguage')" key="language">
          <el-input v-model="flowConditionForm.language" clearable @change="updateFlowCondition" />
        </el-form-item>
        <el-form-item :label="t('designer.scriptType')" key="scriptType">
