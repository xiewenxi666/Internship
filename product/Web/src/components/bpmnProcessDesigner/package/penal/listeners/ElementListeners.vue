<template>
  <div class="panel-tab__content">
    <el-table :data="elementListenersList" size="small" border :table-layout="'auto'">
      ...
      <el-table-column :label="t('designer.eventType')" min-width="100px" prop="event" />
      <el-table-column
    ...
    <el-drawer
      ...
      :title="t('designer.executionListener')"
      :size="`${width}px`"
      append-to-body
      destroy-on-close
    >
      ...
      <p class="listener-filed__title">
        ...
        <XButton type="primary" @click="openListenerFieldForm(null)" :title="t('designer.addField')" />
      </p>
      <el-table
