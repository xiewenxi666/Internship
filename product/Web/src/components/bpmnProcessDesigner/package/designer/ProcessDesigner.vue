    ...
    <div class="my-process-designer__header" style="z-index: 999; display: table-row-group">
      ...
      <template v-if="!$slots['control-header']">
        <ElButtonGroup key="file-control">
          <XButton preIcon="ep:folder-opened" :title="t('designer.openFile')" @click="refFile.click()" />
          <el-tooltip effect="light" placement="bottom">
            <template #content>
              <div style="color: #409eff">
                <!-- <el-button link @click="downloadProcessAsXml()">下载为XML文件</el-button> -->
                <XTextButton :title="t('designer.downloadXml')" @click="downloadProcessAsXml()" />
                <br />

                <!-- <el-button link @click="downloadProcessAsSvg()">下载为SVG文件</el-button> -->
                <XTextButton :title="t('designer.downloadSvg')" @click="downloadProcessAsSvg()" />
                <br />

                <!-- <el-button link @click="downloadProcessAsBpmn()">下载为BPMN文件</el-button> -->
                <XTextButton :title="t('designer.downloadBpmn')" @click="downloadProcessAsBpmn()" />
              </div>
            </template>
            <XButton :title="t('designer.downloadFile')" preIcon="ep:download" />
          </el-tooltip>
          <el-tooltip effect="light">
            <XButton preIcon="ep:view" :title="t('designer.browse')" />
            <template #content>
              <!-- <el-button link @click="previewProcessXML">预览XML</el-button> -->
              <XTextButton :title="t('designer.previewXml')" @click="previewProcessXML" />
              <br />
              <!-- <el-button link @click="previewProcessJson">预览JSON</el-button> -->
              <XTextButton :title="t('designer.previewJson')" @click="previewProcessJson" />
            </template>
          </el-tooltip>
          <el-tooltip
            v-if="props.simulation"
            effect="light"
            :content="simulationStatus ? t('designer.exitSimulation') : t('designer.startSimulation')"
          >
            <XButton preIcon="ep:cpu" :title="t('designer.simulation')" @click="processSimulation" />
          </el-tooltip>
        </ElButtonGroup>
        <ElButtonGroup key="align-control">
          <el-tooltip effect="light" :content="t('designer.alignLeft')">
            <!-- <el-button
          ...
          <el-tooltip effect="light" :content="t('designer.alignRight')">
            <!-- <el-button
          ...
          <el-tooltip effect="light" :content="t('designer.alignTop')">
            <!-- <el-button
              class="align align-top"
              icon="el-icon-s-data"
          ...
          <el-tooltip effect="light" :content="t('designer.alignBottom')">
            <!-- <el-button
              class="align align-bottom"
              icon="el-icon-s-data"
          ...
          <el-tooltip effect="light" :content="t('designer.alignCenter')">
            <!-- <el-button
          ...
          <el-tooltip effect="light" :content="t('designer.alignMiddle')">
            <!-- <el-button
        ...
        <ElButtonGroup key="scale-control">
          <el-tooltip effect="light" :content="t('designer.zoomOut')">
            <!-- <el-button
          ...
          <el-tooltip effect="light" :content="t('designer.zoomIn')">
            <!-- <el-button
          ...
          <el-tooltip effect="light" :content="t('designer.zoomReset')">
        ...
        <ElButtonGroup key="stack-control">
          <el-tooltip effect="light" :content="t('designer.undo')">
          ...
          <el-tooltip effect="light" :content="t('designer.redo')">
            <!-- <el-button
          ...
          <el-tooltip effect="light" :content="t('designer.redraw')">
...
const elementsAlign = (align) => {
  ...
  if (!SelectedElements || SelectedElements.length <= 1) {
    ElMessage.warning(t('designer.selectMultipleElements'))
    // alert('请按住 Ctrl 键选择多个元素对齐
    return
  }
  ElMessageBox.confirm(t('designer.alignWarning'), t('common.warning'), {
