...
const data = reactive({
  ...
  week: [
    {
      value: '1',
      label: computed(() => t('common.sunday'))
    },
    {
      value: '2',
      label: computed(() => t('common.monday'))
    },
    {
      value: '3',
      label: computed(() => t('common.tuesday'))
    },
    {
      value: '4',
      label: computed(() => t('common.wednesday'))
    },
    {
      value: '5',
      label: computed(() => t('common.thursday'))
    },
    {
      value: '6',
      label: computed(() => t('common.friday'))
    },
    {
      value: '7',
      label: computed(() => t('common.saturday'))
    }
  ],
  year: getYear()
})
...
const set = () => {
  ...
  //简单检查
  if (arr.length < 6) {
    ElMessage.warning(t('common.cronExpressionError'))
    arr = '* * * * * ?'.split(' ')
  }
...
<template>
  <el-input v-model="defaultValue" class="input-with-select" v-bind="$attrs" @input="inputChange">
    <template #append>
      <el-select v-model="select" :placeholder="t('common.generator')" style="width: 115px">
        <el-option :label="t('common.everyMinute')" value="0 * * * * ?" />
        <el-option :label="t('common.everyHour')" value="0 0 * * * ?" />
        <el-option :label="t('common.everyDayMidnight')" value="0 0 0 * * ?" />
        <el-option :label="t('common.everyMonthFirstDay')" value="0 0 0 1 * ?" />
        <el-option :label="t('common.everyMonthLastDay')" value="0 0 0 L * ?" />
        <el-option :label="t('common.everyWeekSunday')" value="0 0 0 ? * 1" />
        <el-option
      ...
      <el-tabs>
          ...
          <el-form>
            <el-form-item :label="t('common.type')">
              <el-radio-group v-model="cronValue.second.type">
                <el-radio-button value="0">{{ t('common.anyValue') }}</el-radio-button>
                <el-radio-button value="1">{{ t('common.range') }}</el-radio-button>
                <el-radio-button value="2">{{ t('common.interval') }}</el-radio-button>
                <el-radio-button value="3">{{ t('common.specify') }}</el-radio-button>
              </el-radio-group>
            </el-form-item>
            <el-form-item v-if="cronValue.second.type == '1'" :label="t('common.range')">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.second.type == '2'" :label="t('common.interval')">
              <el-input-number
              ...
              <el-input-number
                ...
                controls-position="right"
              />
              {{ t('common.secondExecute') }}
            </el-form-item>
            <el-form-item v-if="cronValue.second.type == '3'" :label="t('common.specify')">
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.minute.type == '1'" :label="t('common.range')">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.minute.type == '2'" :label="t('common.interval')">
              <el-input-number
              ...
              <el-input-number
                ...
                controls-position="right"
              />
              {{ t('common.minuteExecute') }}
            </el-form-item>
            <el-form-item v-if="cronValue.minute.type == '3'" :label="t('common.specify')">
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.hour.type == '1'" :label="t('common.range')">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.hour.type == '2'" :label="t('common.interval')">
              <el-input-number
              ...
              <el-input-number
                ...
                controls-position="right"
              />
              {{ t('common.hourExecute') }}
            </el-form-item>
            <el-form-item v-if="cronValue.hour.type == '3'" :label="t('common.specify')">
          ...
          <el-form>
            <el-form-item :label="t('common.type')">
              <el-radio-group v-model="cronValue.day.type">
                ...
                <el-radio-button value="2">{{ t('common.interval') }}</el-radio-button>
                <el-radio-button value="3">{{ t('common.specify') }}</el-radio-button>
                <el-radio-button value="4">{{ t('common.lastDayOfMonth') }}</el-radio-button>
                <el-radio-button value="5">{{ t('common.notSpecified') }}</el-radio-button>
              </el-radio-group>
            </el-form-item>
            <el-form-item v-if="cronValue.day.type == '1'" :label="t('common.range')">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.day.type == '2'" :label="t('common.interval')">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.day.type == '3'" :label="t('common.specify')">
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.month.type == '1'" :label="t('common.range')">
              <el-input-number
            ...
            <el-form-item v-if="cronValue.month.type == '2'" :label="t('common.interval')">
              <el-input-number
              ...
              <el-input-number
                ...
                controls-position="right"
              />
              {{ t('common.monthExecute') }}
            </el-form-item>
            <el-form-item v-if="cronValue.month.type == '3'" :label="t('common.specify')">
            ...
            <el-form>
              <el-form-item :label="t('common.type')">
                <el-radio-group v-model="cronValue.week.type">
                  ...
                  <el-radio-button value="2">{{ t('common.interval') }}</el-radio-button>
                  <el-radio-button value="3">{{ t('common.specify') }}</el-radio-button>
                  <el-radio-button value="4">{{ t('common.lastWeekOfMonth') }}</el-radio-button>
                  <el-radio-button value="5">{{ t('common.notSpecified') }}</el-radio-button>
                </el-radio-group>
              </el-form-item>
              <el-form-item v-if="cronValue.week.type == '1'" :label="t('common.range')">
              ...
              <el-form-item v-if="cronValue.week.type == '2'" :label="t('common.interval')">
                {{ t('common.weekNum') }}
                <el-input-number
                ...
                {{ t('common.executeOnce') }}
              </el-form-item>
              <el-form-item v-if="cronValue.week.type == '3'" :label="t('common.specify')">
              ...
              <el-form-item v-if="cronValue.week.type == '4'" :label="t('common.lastWeekOfMonth')">
          ...
          <el-form>
            <el-form-item :label="t('common.type')">
              <el-radio-group v-model="cronValue.year.type">
                <el-radio-button value="-1">{{ t('common.ignore') }}</el-radio-button>
                <el-radio-button value="0">{{ t('common.anyValue') }}</el-radio-button>
                <el-radio-button value="1">{{ t('common.range') }}</el-radio-button>
                <el-radio-button value="2">{{ t('common.interval') }}</el-radio-button>
                <el-radio-button value="3">{{ t('common.specify') }}</el-radio-button>
            ...
            <el-form-item v-if="cronValue.year.type == '1'" :label="t('common.range')">
            ...
            <el-form-item v-if="cronValue.year.type == '2'" :label="t('common.interval')">
              ...
              <el-input-number
                ...
                controls-position="right"
              />
              {{ t('common.yearExecute') }}
            </el-form-item>
            <el-form-item v-if="cronValue.year.type == '3'" :label="t('common.specify')">
