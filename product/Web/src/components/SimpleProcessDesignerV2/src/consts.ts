...
// 节点默认提示文字的 i18n 键映射
export const NODE_DEFAULT_TEXT_KEY = new Map<number, string>()
NODE_DEFAULT_TEXT_KEY.set(NodeType.USER_TASK_NODE, 'configureApprover')
NODE_DEFAULT_TEXT_KEY.set(NodeType.COPY_TASK_NODE, 'configureCopyPerson')
NODE_DEFAULT_TEXT_KEY.set(NodeType.CONDITION_NODE, 'configureCondition')
NODE_DEFAULT_TEXT_KEY.set(NodeType.START_USER_NODE, 'configureInitiator')
NODE_DEFAULT_TEXT_KEY.set(NodeType.DELAY_TIMER_NODE, 'configureDelayTimer')
NODE_DEFAULT_TEXT_KEY.set(NodeType.ROUTER_BRANCH_NODE, 'configureRouterNode')
NODE_DEFAULT_TEXT_KEY.set(NodeType.TRIGGER_NODE, 'configureTrigger')
NODE_DEFAULT_TEXT_KEY.set(NodeType.TRANSACTOR_NODE, 'configureHandler')
NODE_DEFAULT_TEXT_KEY.set(NodeType.CHILD_PROCESS_NODE, 'configureChildProcess')
...
// 节点默认名称的 i18n 键映射
export const NODE_DEFAULT_NAME_KEY = new Map<number, string>()
NODE_DEFAULT_NAME_KEY.set(NodeType.USER_TASK_NODE, 'approver')
NODE_DEFAULT_NAME_KEY.set(NodeType.COPY_TASK_NODE, 'copy')
NODE_DEFAULT_NAME_KEY.set(NodeType.CONDITION_NODE, 'condition')
NODE_DEFAULT_NAME_KEY.set(NodeType.START_USER_NODE, 'initiator')
NODE_DEFAULT_NAME_KEY.set(NodeType.DELAY_TIMER_NODE, 'delayTimer')
NODE_DEFAULT_NAME_KEY.set(NodeType.ROUTER_BRANCH_NODE, 'routerBranch')
NODE_DEFAULT_NAME_KEY.set(NodeType.TRIGGER_NODE, 'trigger')
NODE_DEFAULT_NAME_KEY.set(NodeType.TRANSACTOR_NODE, 'handler')
NODE_DEFAULT_NAME_KEY.set(NodeType.CHILD_PROCESS_NODE, 'childProcess')
