<template>
  ...
  >
    ...
    <el-tabs type="border-card" v-model="activeTabName">
      <el-tab-pane :label="t('simpleDesigner.childProcessLabel')" name="child">
        <div>
          <el-form ref="formRef" :model="configForm" label-position="top" :rules="formRules">
            <el-form-item :label="t('simpleDesigner.isAsync')" prop="async">
              <el-switch v-model="configForm.async" :active-text="t('simpleDesigner.asyncLabel')" :inactive-text="t('simpleDesigner.notAsyncLabel')" />
            </el-form-item>
            <el-form-item :label="t('simpleDesigner.selectChildProcess')" prop="calledProcessDefinitionKey">
              <el-select
            ...
            <el-form-item :label="t('simpleDesigner.skipStartUserNode')" prop="skipStartUserNode">
              <el-switch
                v-model="configForm.skipStartUserNode"
                :active-text="t('simpleDesigner.skipLabel')"
                :inactive-text="t('simpleDesigner.notSkipLabel')"
              />
            </el-form-item>
            <el-form-item :label="t('simpleDesigner.mainToChildVariable')" prop="inVariables">
              ...
              <el-button type="primary" text @click="addVariable(configForm.inVariables)">
                <Icon icon="ep:plus" class="mr-5px" />{{ t('simpleDesigner.addRow') }}
              </el-button>
            </el-form-item>
            <el-form-item
              v-if="configForm.async === false"
              :label="t('simpleDesigner.childToMainVariable')"
              prop="outVariables"
            >
            ...
            <el-form-item :label="t('simpleDesigner.childProcessInitiator')" prop="startUserType">
            ...
            <el-form-item
              ...
              :label="t('simpleDesigner.whenChildProcessInitiatorEmpty')"
              prop="startUserType"
            >
            ...
            <el-form-item
              ...
              :label="t('simpleDesigner.initiatorForm')"
            ...
            <el-divider content-position="left">{{ t('simpleDesigner.timeoutSetting') }}</el-divider>
            <el-form-item :label="t('simpleDesigner.enableSwitch')" prop="timeoutEnable">
              <el-switch
            ...
            <div v-if="configForm.timeoutEnable">
              ...
              >
                <el-date-picker
                  ...
                  type="datetime"
                  :placeholder="t('simpleDesigner.selectDateTime')"
            ...
            <el-divider content-position="left">{{ t('simpleDesigner.multiInstanceSetting') }}</el-divider>
            <el-form-item :label="t('simpleDesigner.enableSwitch')" prop="multiInstanceEnable">
              <el-switch
            ...
            <div v-if="configForm.multiInstanceEnable">
              <el-form-item prop="sequential">
                <el-switch
                  ...
                  :active-text="t('simpleDesigner.serialLabel')"
                  :inactive-text="t('simpleDesigner.parallelLabel')"
                />
              </el-form-item>
              <el-form-item prop="approveRatio">
                <el-text>{{ t('simpleDesigner.completionRatio') }}</el-text>
                <el-input-number
                  class="ml-10px"
              ...
              <el-form-item prop="multiInstanceSourceType">
                <el-text>{{ t('simpleDesigner.multiInstanceSource') }}</el-text>
                <el-select
