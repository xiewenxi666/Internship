...
const beforeUpload: UploadProps['beforeUpload'] = (rawFile) => {
  ...
  if (!imgType.includes(rawFile.type as FileTypes))
    message.notifyWarning(`${t('common.image')} ${t('common.uploadFailed')}`)
  if (!imgSize) message.notifyWarning(`${t('common.image')} ${t('common.fileSizeError')} ${props.fileSize}M!`)
...
// 图片上传错误提示
const uploadError = () => {
  message.notifyError(`${t('common.image')} ${t('common.uploadFailed')}！`)
}
</script>
