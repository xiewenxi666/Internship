<template>
  <div class="flex flex-row items-center gap-2">
    <el-radio-group v-model="shortcutDays" @change="handleShortcutDaysChange">
      <el-radio-button :value="1">{{ t('common.yesterday') }}</el-radio-button>
      <el-radio-button :value="7">{{ t('common.last7Days') }}</el-radio-button>
      <el-radio-button :value="30">{{ t('common.last30Days') }}</el-radio-button>
    </el-radio-group>
    <el-date-picker
      v-model="times"
