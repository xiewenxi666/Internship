...
<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item :label="t('warehouseId')" prop="warehouseId">
        <el-select
      ...
      <el-form-item :label="t('bizType')" prop="bizType">
        <el-select
      ...
      <el-form-item :label="t('bizNo')" prop="bizNo">
        <el-input
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" :table-layout="'auto'">
      <el-table-column :label="t('productName')" align="center" prop="productName" />
      <el-table-column :label="t('categoryName')" align="center" prop="categoryName" />
      <el-table-column :label="t('unitName')" align="center" prop="unitName" />
      <el-table-column :label="t('warehouseName')" align="center" prop="warehouseName" />
      <el-table-column :label="t('bizType')" align="center" prop="bizType" min-width="100">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.ERP_STOCK_RECORD_BIZ_TYPE" :value="scope.row.bizType" />
        </template>
      </el-table-column>
      <el-table-column :label="t('bizNo')" align="center" prop="bizNo" min-width="200" />
      <el-table-column
      ...
      <el-table-column
        ...
        :formatter="erpCountTableColumnFormatter"
      />
      <el-table-column :label="t('common.creator')" align="center" prop="creatorName" />
    </el-table>
    <!-- 分页 -->
    <Pagination
      :total="total"
...
const { t } = useI18n('erp.stock.record') // 国际化
