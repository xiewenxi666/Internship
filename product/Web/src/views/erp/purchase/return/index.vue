<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item :label="t('returnTime')" prop="inTime">
        <el-date-picker
      ...
      <el-form-item :label="t('refundStatus')" prop="refundStatus">
        <el-select
          v-model="queryParams.refundStatus"
          :placeholder="t('selectRefundStatus')"
          clearable
          class="!w-240px"
        >
          <el-option :label="t('notRefund')" value="0" />
          <el-option :label="t('partialRefund')" value="1" />
          <el-option :label="t('allRefund')" value="2" />
        </el-select>
      </el-form-item>
    ...
    <el-table
     ...
     :table-layout="'auto'">
      ...
      <el-table-column
        ...
        :formatter="erpPriceTableColumnFormatter"
      />
      <el-table-column :label="t('unrefunded')" align="center">
