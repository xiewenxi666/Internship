  ...
  <ContentWrap>
    ...
    >
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('status')" prop="status">
            <el-select v-model="queryParams.status" :placeholder="t('selectStatus')" clearable class="!w-240px">
              <el-option
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('inCount')" prop="inStatus">
            <el-select
              v-model="queryParams.inStatus"
              :placeholder="t('selectInStatus')"
              clearable
              class="!w-240px"
            >
              <el-option :label="t('notIn')" value="0" />
              <el-option :label="t('partialIn')" value="1" />
              <el-option :label="t('allIn')" value="2" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('returnCount')" prop="returnStatus">
            <el-select
              v-model="queryParams.returnStatus"
              :placeholder="t('selectReturnStatus')"
              clearable
              class="!w-240px"
            >
