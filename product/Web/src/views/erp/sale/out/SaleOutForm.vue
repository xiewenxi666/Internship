  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1440">
    ...
    >
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('receivableAmount')">
...
const { t } = useI18n('erp.sale.out') // 国际化
...
const formRules = reactive({
  ...
  outTime: [{ required: true, message: t('outTimeRequired'), trigger: 'blur' }]
})
