<template>
  ...
  <ContentWrap>
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('product.unit.name')" prop="name">
            <el-input
              v-model="queryParams.name"
              :placeholder="t('product.unit.namePlaceholder')"
              clearable
        ...
        <el-col :span="12">
          <el-form-item :label="t('product.unit.status')" prop="status">
            <el-select
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('product.unit.exportFilename') + '.xls')
  } catch {
  } finally {
