<template>
  ...
  <ContentWrap>
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('product.category.status')" prop="status">
            <el-select
        ...
        <el-col :span="24">
          <el-form-item>
            ...
            <el-button type="danger" plain @click="toggleExpandAll">
              <Icon icon="ep:sort" class="mr-5px" /> {{ t('product.category.expandCollapse') }}
            </el-button>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  <ContentWrap>
    <el-table
      ...
      v-if="refreshTable"
     :table-layout="'auto'">
      <el-table-column :label="t('product.category.code')" align="center" prop="code" />
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('product.category.exportFilename') + '.xls')
  } catch {
  } finally {
