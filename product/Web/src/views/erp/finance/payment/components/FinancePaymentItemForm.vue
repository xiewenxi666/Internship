<template>
  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px" :table-layout="'auto'">
      ...
      <el-table-column :label="t('payableAmount')" prop="totalPrice" fixed="right" min-width="100">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('paidAmount')" prop="paidPrice" fixed="right" min-width="100">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('currentPayment')" prop="paymentPrice" fixed="right" min-width="115">
  ...
  <el-row justify="center" class="mt-3" v-if="!disabled">
    <el-button @click="handleOpenPurchaseIn" round>+ {{ t('addPurchaseIn') }}</el-button>
    <el-button @click="handleOpenPurchaseReturn" round>+ {{ t('addPurchaseReturn') }}</el-button>
  </el-row>
...
const handleOpenPurchaseIn = () => {
  if (!props.supplierId) {
    message.error(t('selectSupplierFirst'))
    return
  }
