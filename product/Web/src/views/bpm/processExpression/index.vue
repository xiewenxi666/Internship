<template>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('processExpression.name')" prop="name">
            <el-input
              ...
              :placeholder="t('processExpression.namePlaceholder')"
              clearable
        ...
        <el-col :span="8">
          <el-form-item :label="t('processExpression.status')" prop="status">
            <el-select v-model="queryParams.status" :placeholder="t('processExpression.statusPlaceholder')" clearable class="!w-240px">
              <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" :table-layout="'auto'">
      ...
      <el-table-column :label="t('processExpression.name')" align="center" prop="name" />
      <el-table-column :label="t('common.status')" align="center" prop="status">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.COMMON_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column :label="t('processExpression.expression')" align="center" prop="expression" />
      <el-table-column
