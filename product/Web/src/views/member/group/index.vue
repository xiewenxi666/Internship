<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" :table-layout="'auto'">
      <el-table-column :label="t('group.id')" align="center" prop="id" min-width="60" />
      <el-table-column :label="t('group.name')" align="center" prop="name" min-width="80" />
      <el-table-column :label="t('group.remark')" align="center" prop="remark" min-width="100" />
      <el-table-column :label="t('group.status')" align="center" prop="status" min-width="70">
      ...
      <el-table-column
        ...
        min-width="170"
       fixed="right" />
      <el-table-column :label="t('common.action')" align="center" min-width="150">
        <template #default="scope">
          <el-button
            link
            type="primary"
