<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="65%">
    ...
    >
      <template #spuId>
        <el-button @click="spuSelectRef.open()">{{ t('mall.promotion.bargain.selectProduct') }}</el-button>
        <SpuAndSkuList
        ...
        >
          <el-table-column align="center" :label="t('mall.promotion.bargain.bargainFirstPriceLabel')" min-width="168">
          ...
          <el-table-column align="center" :label="t('mall.promotion.bargain.bargainMinPriceLabel')" min-width="168">
            <template #default="{ row: sku }">
              <el-input-number
          ...
          <el-table-column align="center" :label="t('mall.promotion.bargain.activityStock')" min-width="168">
            <template #default="{ row: sku }">
...
const ruleConfig: RuleConfig[] = [
  {
    ...
    rule: (arg) => arg > 0,
    message: t('mall.promotion.bargain.bargainFirstPriceRequired')
  },
  {
    name: 'productConfig.bargainMinPrice',
    rule: (arg) => arg >= 0,
    message: t('mall.promotion.bargain.bargainMinPriceRequired')
  },
  {
    name: 'productConfig.stock',
    rule: (arg) => arg >= 1,
    message: t('mall.promotion.bargain.stockRequired')
  }
]
