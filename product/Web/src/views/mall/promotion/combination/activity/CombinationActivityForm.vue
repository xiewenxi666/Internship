<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="65%">
    ...
    >
      <template #spuId>
        <el-button @click="spuSelectRef.open()">{{ t('combination.selectProduct') }}</el-button>
        <SpuAndSkuList
        ...
        >
          <el-table-column align="center" :label="t('combination.combinationPriceLabel')" min-width="168">
    ...
    <template #footer>
      <el-button :disabled="formLoading" type="primary" @click="submitForm">{{ t('combination.confirm') }}</el-button>
...
const ruleConfig: RuleConfig[] = [
  {
    ...
    rule: (arg) => arg >= 0.01,
    message: t('combination.priceMinError')
  }
]
