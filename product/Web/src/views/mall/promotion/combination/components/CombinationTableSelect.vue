  ...
  <Dialog v-model="dialogVisible" :appendToBody="true" :title="t('combination.selectActivity')" width="70%">
    <ContentWrap>
      ...
      <el-table v-loading="loading" :data="list" show-overflow-tooltip :table-layout="'auto'">
        ...
        <el-table-column :label="t('combination.activityId')" prop="id" min-width="80" />
        <el-table-column :label="t('combination.name')" prop="name" min-width="140" />
        ...
        <el-table-column :label="t('combination.picUrl')" prop="spuName" min-width="80">
          <template #default="scope">
            <el-image
        ...
        <el-table-column :label="t('combination.spuName')" prop="spuName" min-width="300" />
        <el-table-column
        ...
        <el-table-column :label="t('combination.status')" align="center" prop="status" min-width="100">
          <template #default="scope">
    ...
    <template #footer v-if="multiple">
      <el-button type="primary" @click="handleEmitChange">{{ t('combination.confirm') }}</el-button>
      <el-button @click="dialogVisible = false">{{ t('combination.cancel') }}</el-button>
    </template>
  </Dialog>
</template>
