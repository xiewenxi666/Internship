<template>
  <Dialog v-model="dialogVisible" :title="t('mall.trade.afterSale.disagreeTitle')" width="45%">
    <el-form ref="formRef" v-loading="formLoading" :model="formData" label-width="auto">
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('mall.trade.afterSale.auditRemark')">
            <el-input
              v-model="formData.auditReason"
              :rows="3"
              :placeholder="t('mall.trade.afterSale.auditRemarkPlaceholder')"
              type="textarea"
            />
          </el-form-item>
        </el-col>
