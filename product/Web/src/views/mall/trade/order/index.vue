<template>
  ...
  <ContentWrap>
    ...
    >
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('mall.trade.order.status')" prop="status">
            <el-select v-model="queryParams.status" class="!w-280px" clearable :placeholder="t('common.all')">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item :label="t('mall.trade.order.payChannelCode')" prop="payChannelCode">
            <el-select
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('mall.trade.order.orderSource')" prop="terminal">
            <el-select v-model="queryParams.terminal" class="!w-280px" clearable :placeholder="t('common.all')">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item :label="t('mall.trade.order.orderType')" prop="type">
            <el-select v-model="queryParams.type" class="!w-280px" clearable :placeholder="t('common.all')">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item :label="t('mall.trade.order.deliveryType')" prop="deliveryType">
            <el-select v-model="queryParams.deliveryType" class="!w-280px" clearable :placeholder="t('common.all')">
              <el-option
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item
            ...
            :label="t('mall.trade.order.expressCompany')"
            prop="logisticsId"
          >
            <el-select v-model="queryParams.logisticsId" class="!w-280px" clearable :placeholder="t('common.all')">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item
            ...
            :label="t('mall.trade.order.pickUpStore')"
            prop="pickUpStoreId"
          >
            <el-select
        ...
        <el-col :span="8">
          <el-form-item
            v-if="queryParams.deliveryType === DeliveryTypeEnum.PICK_UP.type"
            :label="t('mall.trade.order.pickUpVerifyCode')"
          ...
          >
            <el-input
              ...
              class="!w-280px"
              clearable
              :placeholder="t('mall.trade.order.pickUpVerifyCodePlaceholder')"
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('mall.trade.order.aggregateSearch')">
            <el-input
              v-show="true"
  ...
  <!-- 列表 -->
  <ContentWrap>
    <!-- 添加 row-key="id" 解决列数据中 el-table#header 数据不刷新的问题  -->
    <el-table v-loading="loading" :data="list" row-key="id" :table-layout="'auto'">
