<template>
  <Dialog v-model="dialogVisible" :title="t('mall.trade.order.adjustPriceTitle')" width="25%">
    <el-form ref="formRef" v-loading="formLoading" :model="formData" label-width="auto">
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('mall.trade.order.payableAmountTotal')">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('mall.trade.order.adjustPriceLabel')">
            <el-input-number v-model="formData.adjustPrice" :precision="2" :step="0.1" class="w-100%" />
            <el-tag class="ml-10px" type="warning">{{ t('mall.trade.order.adjustPriceTip') }}</el-tag>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('mall.trade.order.afterAdjustPrice')">
