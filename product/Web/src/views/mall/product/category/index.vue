<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" row-key="id" default-expand-all :table-layout="'auto'">
      ...
      <el-table-column :label="t('category.sort')" align="center" min-width="150" prop="sort" />
      <el-table-column :label="t('category.status')" align="center" min-width="150" prop="status">
        <template #default="scope">
