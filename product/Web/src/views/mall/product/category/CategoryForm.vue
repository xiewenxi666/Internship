<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('category.parentId')" prop="parentId">
            <el-select v-model="formData.parentId" :placeholder="t('category.parentIdPlaceholder')">
        ...
        <el-col :span="12">
          <el-form-item :label="t('category.categoryName')" prop="name">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('category.mobileCategoryImage')" prop="picUrl">
            <UploadImg v-model="formData.picUrl" :limit="1" :is-show-tip="false" />
            <div style="font-size: 10px" class="pl-10px">{{ t('category.imageResolutionTip') }}</div>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('category.categorySort')" prop="sort">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('category.enableStatus')" prop="status">
...
const formRules = reactive({
  ...
  picUrl: [{ required: true, message: t('category.picUrlRequired'), trigger: 'blur' }],
  sort: [{ required: true, message: t('category.sortRequired'), trigger: 'blur' }],
  status: [{ required: true, message: t('category.statusRequired'), trigger: 'blur' }]
})
