<template>
  <Dialog v-model="dialogVisible" :title="t('comment.addVirtualComment')">
    <el-form
      ref="formRef"
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('comment.product')" prop="spuId">
            <SpuShowcase v-model="formData.spuId" :limit="1" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="formData.spuId" :label="t('comment.productSpec')" prop="skuId">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('comment.userAvatar')" prop="userAvatar">
            <UploadImg v-model="formData.userAvatar" height="60px" width="60px" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('comment.userName')" prop="userNickname">
            <el-input v-model="formData.userNickname" :placeholder="t('comment.userNicknamePlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('comment.commentContent')" prop="content">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('comment.descriptionStar')" prop="descriptionScores">
            <el-rate v-model="formData.descriptionScores" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('comment.benefitStar')" prop="benefitScores">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('comment.commentImages')" prop="picUrls">
...
const formRules = reactive({
  spuId: [{ required: true, message: t('comment.spuIdRequired'), trigger: 'blur' }],
  skuId: [{ required: true, message: t('comment.skuIdRequired'), trigger: 'blur' }],
  userAvatar: [{ required: true, message: t('comment.userAvatarRequired'), trigger: 'blur' }],
  userNickname: [{ required: true, message: t('comment.userNicknameRequired'), trigger: 'blur' }],
  content: [{ required: true, message: t('comment.contentRequired'), trigger: 'blur' }],
  descriptionScores: [{ required: true, message: t('comment.descriptionScoresRequired'), trigger: 'blur' }],
