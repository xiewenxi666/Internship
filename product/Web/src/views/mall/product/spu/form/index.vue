<template>
  <ContentWrap v-loading="formLoading">
    <el-tabs v-model="activeName">
      <el-tab-pane :label="t('spu.tabInfo')" name="info">
        <InfoForm
          ref="infoRef"
      ...
      <el-tab-pane :label="t('spu.tabSku')" name="sku">
        <SkuForm
          ref="skuRef"
          v-model:activeName="activeName"
          :is-detail="isDetail"
      ...
      <el-tab-pane :label="t('spu.tabDelivery')" name="delivery">
        <DeliveryForm
          ref="deliveryRef"
          v-model:activeName="activeName"
          :is-detail="isDetail"
      ...
      <el-tab-pane :label="t('spu.tabDescription')" name="description">
        <DescriptionForm
          ref="descriptionRef"
          v-model:activeName="activeName"
          :is-detail="isDetail"
      ...
      <el-tab-pane :label="t('spu.tabOther')" name="other">
        <OtherForm
          ref="otherRef"
          v-model:activeName="activeName"
          :is-detail="isDetail"
...
const submitForm = async () => {
  ...
  try {
    ...
    if (isEmpty(deepCopyFormData.name)) {
      message.error(t('spu.nameRequired'))
      return
    }
