    ...
    <el-row :gutter="16" class="summary">
      ...
      <el-col v-loading="loading" :sm="6" :xs="12">
        <SummaryCard
          ...
          :title="t('totalRechargeUserCount')"
        />
      </el-col>
      <el-col v-loading="loading" :sm="6" :xs="12">
        <SummaryCard
    ...
    <el-row :gutter="16">
      <el-col :md="18" :sm="24">
        <el-card shadow="never">
          <template #header>
            <CardTitle :title="t('areaDistribution')" />
          </template>
          <el-row v-loading="loading">
            ...
            <el-col :span="14">
              <el-table :data="areaStatisticsList" :height="300" :table-layout="'auto'">
                <el-table-column
...
const { t } = useI18n('mall.statistics.member')
...
${t('userCount')}：${params?.data?.userCount || 0}<br/>
${t('orderCreateUserCount')}：${params?.data?.orderCreateUserCount || 0}<br/>
${t('orderPayUserCount')}：${params?.data?.orderPayUserCount || 0}<br/>
${t('orderPayPrice')}：${fenToYuan(params?.data?.orderPayPrice || 0)}`
    }
  },
  visualMap: {
