<template>
  ...
  <div class="flex flex-col">
    <el-row :gutter="16" class="summary">
      <el-col :sm="6" :xs="12">
        <TradeStatisticValue
          :tooltip="t('yesterdayOrderCount')"
          :title="t('yesterdayOrderCount')"
      ...
      <el-col :sm="6" :xs="12">
        <TradeStatisticValue
          :tooltip="t('monthOrderCount')"
          :title="t('monthOrderCount')"
      ...
      <el-col :sm="6" :xs="12">
        <TradeStatisticValue
          :tooltip="t('yesterdayPayPrice')"
          :title="t('yesterdayPayPrice')"
          prefix="￥"
          :decimals="2"
      ...
      <el-col :sm="6" :xs="12">
        <TradeStatisticValue
          :tooltip="t('monthPayPrice')"
          :title="t('monthPayPrice')"
          prefix="￥"
          ::decimals="2"
    ...
    <el-card shadow="never">
      ...
      <el-row :gutter="16">
        <el-col :md="6" :sm="12" :xs="24">
          <SummaryCard
            :title="t('turnoverPrice')"
            :tooltip="t('turnoverPriceTip')"
        ...
        <el-col :md="6" :sm="12" :xs="24">
          <SummaryCard
            :title="t('rechargePrice')"
            :tooltip="t('rechargePriceTip')"
        ...
        <el-col :md="6" :sm="12" :xs="24">
          <SummaryCard
            :title="t('expensePrice')"
            :tooltip="t('expensePriceTip')"
        ...
        <el-col :md="6" :sm="12" :xs="24">
          <SummaryCard
            :title="t('walletPayPrice')"
            :tooltip="t('walletPayPriceTip')"
        ...
        <el-col :md="6" :sm="12" :xs="24">
          <SummaryCard
            :title="t('brokerageSettlementPrice')"
            :tooltip="t('brokerageSettlementPriceTip')"
            icon="fa-solid:award"
            icon-color="bg-yellow-100"
            icon-bg-color="text-yellow-500"
            prefix="￥"
...
const { t } = useI18n('mall.statistics.trade')
...
const lineChartOptions = reactive<EChartsOption>({
  ...
  series: [
    { name: t('turnoverPrice'), type: 'line', smooth: true },
    { name: t('orderPayPrice'), type: 'line', smooth: true },
    { name: t('rechargePrice'), type: 'line', smooth: true },
    { name: t('expensePrice'), type: 'line', smooth: true }
  ],
  toolbox: {
    feature: {
      // 数据区域缩放
      ...
      saveAsImage: { show: true, name: t('tradeStatus') } // 保存为图片
    }
  },
  tooltip: {
    trigger: 'axis',
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('tradeStatus') + '.xls')
  } catch {
  } finally {
