...
<template>
  ...
  <div class="w-full mt-30px">
    <div>
      <el-text tag="b">{{ t('image.size') }}</el-text>
    </div>
  ...
  <div class="mt-20px">
    <div>
      <el-text tag="b">{{ t('image.version') }}</el-text>
    </div>
    <el-space wrap class="mt-20px w-full">
      <el-select
        ...
        class="!w-350px"
        clearable
        :placeholder="t('image.pleaseSelectVersion')"
      >
        <el-option
  ...
  <div class="mt-30px">
    <div>
      <el-text tag="b">{{ t('image.referenceImage') }}</el-text>
    </div>
    <el-space wrap class="mt-15px">
