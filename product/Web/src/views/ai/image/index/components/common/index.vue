...
<template>
  ...
  <div class="mt-30px">
    <div>
      <el-text tag="b">{{ t('image.platformLabel') }}</el-text>
    </div>
  ...
  <div class="mt-30px">
    <div>
      <el-text tag="b">{{ t('image.modelLabel') }}</el-text>
    </div>
    <el-space wrap class="mt-15px w-full">
  ...
  <div class="mt-30px">
    ...
    <el-space wrap class="mt-15px w-full">
      <el-input v-model="width" type="number" class="w-170px" :placeholder="t('image.imageWidth')" />
      <el-input v-model="height" type="number" class="w-170px" :placeholder="t('image.imageHeight')" />
    </el-space>
  </div>
