...
<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-row>
        <el-col :span="8">
          <el-form-item :label="t('thing.model.type')" prop="type">
        ...
        <el-col :span="8">
          <el-form-item :label="t('thing.model.name')" prop="name">
            <el-input v-model="formData.name" :placeholder="t('thing.model.namePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item :label="t('thing.model.identifier')" prop="identifier">
            <el-input v-model="formData.identifier" :placeholder="t('thing.model.identifierPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 属性配置 -->
      ...
      />
      <el-form-item :label="t('thing.model.description')" prop="description">
        <el-input
          v-model="formData.description"
          :maxlength="200"
          :rows="3"
          :placeholder="t('thing.model.descriptionPlaceholder')"
          type="textarea"
        />
      </el-form-item>
    </el-form>
