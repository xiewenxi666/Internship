<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="870">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('rule.data.name')" prop="name">
            <el-input v-model="formData.name" :placeholder="t('rule.data.namePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('rule.data.description')" prop="description">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('rule.data.sink')" prop="sinkIds">
            <el-select
              v-model="formData.sinkIds"
              :placeholder="t('rule.data.selectDataSink')"
              multiple
              clearable
              class="w-1/1"
            >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('rule.data.source')" prop="sourceConfigs">
...
const formRules = reactive({
  name: [{ required: true, message: t('rule.data.nameRequired'), trigger: 'blur' }],
  status: [{ required: true, message: t('rule.data.statusRequired'), trigger: 'blur' }],
  sourceConfigs: [{ required: true, message: t('rule.data.sourceConfigRequired'), trigger: 'blur' }],
  sinkIds: [{ required: true, message: t('rule.data.sinkIdsRequired'), trigger: 'blur' }]
})
