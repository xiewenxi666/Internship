  ...
  <el-card class="chart-card" shadow="never" :loading="loading">
    <template #header>
      <div class="flex items-center">
        <span class="text-base font-medium text-gray-600">{{ t('home.deviceStatusStatistics') }}</span>
      </div>
    </template>
    ...
    <el-row v-else class="h-[240px]">
      <el-col :span="8" class="flex flex-col items-center">
        ...
        <div class="text-center mt-2">
          <span class="text-sm text-gray-600">{{ t('home.deviceOnline') }}</span>
        </div>
      </el-col>
      <el-col :span="8" class="flex flex-col items-center">
        <div ref="deviceOfflineChartRef" class="h-[160px] w-full"></div>
        <div class="text-center mt-2">
          <span class="text-sm text-gray-600">{{ t('home.deviceOffline') }}</span>
        </div>
      </el-col>
      <el-col :span="8" class="flex flex-col items-center">
        <div ref="deviceActiveChartRef" class="h-[160px] w-full"></div>
        <div class="text-center mt-2">
          <span class="text-sm text-gray-600">{{ t('home.pendingDevice') }}</span>
        </div>
      </el-col>
    </el-row>
  </el-card>
