<template>
        ...
        <el-col :span="8">
          <el-form-item :label="t('system.mail.mail')" prop="mail">
            <el-input
              ...
              :placeholder="t('system.mail.mailPlaceholder')"
              clearable
              class="!w-240px"
        ...
        <el-col :span="8">
          <el-form-item :label="t('system.mail.username')" prop="username">
            <el-input
              ...
              :placeholder="t('system.mail.usernamePlaceholder')"
              clearable
              class="!w-240px"
              @keyup.enter="handleQuery"
            />
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item>
            ...
            >
              <Icon icon="ep:plus" class="mr-5px" /> {{ t('action.create') }}</el-button
            >
            <el-button
              type="danger"
              plain
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('system.mail.mail')" align="center" prop="mail" />
      <el-table-column :label="t('system.mail.username')" align="center" prop="username" />
      <el-table-column :label="t('system.mail.host')" align="center" prop="host" />
      <el-table-column :label="t('system.mail.port')" align="center" prop="port" />
      <el-table-column :label="t('system.mail.sslEnable')" align="center" prop="sslEnable">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.INFRA_BOOLEAN_STRING" :value="scope.row.sslEnable" />
        </template>
      </el-table-column>
      <el-table-column :label="t('system.mail.starttlsEnable')" align="center" prop="starttlsEnable">
        <template #default="scope">
