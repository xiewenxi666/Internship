<template>
  <Dialog v-model="dialogVisible" :title="t('system.role.assignDataScope')" width="800">
    <el-form ref="formRef" v-loading="formLoading" :model="formData" label-width="auto">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('system.role.permissionRange')">
