<template>
        ...
        <el-col :span="8">
          <el-form-item :label="t('system.role.name')" prop="name">
            <el-input
              ...
              class="!w-240px"
              clearable
              :placeholder="t('common.inputText') + t('system.role.name')"
        ...
        <el-col :span="8">
          <el-form-item :label="t('system.role.code')" prop="code">
            <el-input
              ...
              class="!w-240px"
              clearable
              :placeholder="t('common.inputText') + t('system.role.code')"
              @keyup.enter="handleQuery"
            />
          </el-form-item>
        </el-col>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column align="center" :label="t('system.role.status')" prop="status">
        <template #default="scope">
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('common.exportFilename.roleData') + '.xls')
  } catch {
  } finally {
