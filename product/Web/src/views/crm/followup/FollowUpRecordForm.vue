<!-- 跟进记录的添加表单弹窗 -->
<template>
  <Dialog v-model="dialogVisible" :title="t('followUp.createFollowUp')" width="50%">
    <el-form
      ref="formRef"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('followUp.type')" prop="type">
            <el-select v-model="formData.type" :placeholder="t('common.selectPlaceholder')">
              <el-option
        ...
        <el-col :span="12">
          <el-form-item :label="t('followUp.contactNextTime')" prop="nextTime">
            <el-date-picker
              v-model="formData.nextTime"
              :placeholder="t('followUp.contactNextTime')"
              type="date"
              value-format="x"
            />
          </el-form-item>
        ...
        <el-col :span="24" v-if="formData.bizType == BizTypeEnum.CRM_CUSTOMER">
          <el-form-item :label="t('followUp.businessIds')" prop="businessIds">
...
const formRules = reactive({
  type: [{ required: true, message: t('followUp.typeRequired'), trigger: 'change' }],
  content: [{ required: true, message: t('followUp.contentRequired'), trigger: 'blur' }],
  nextTime: [{ required: true, message: t('followUp.nextTimeRequired'), trigger: 'blur' }]
})
