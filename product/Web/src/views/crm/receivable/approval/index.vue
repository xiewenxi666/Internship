<template>
  <doc-alert title="【回款】回款审批" url="https://doc.iocoder.cn/crm/receivable/" />
  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" :table-layout="'auto'">
      <el-table-column align="center" fixed="left" label="回款编号" prop="no" min-width="180">
...
defineOptions({ name: 'ReceivableApproval' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await ReceivableApi.getReceivableApprovalPage(queryParams)
