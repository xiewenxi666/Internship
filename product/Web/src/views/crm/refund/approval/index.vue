<template>
  <doc-alert title="【退款】退款审批" url="https://doc.iocoder.cn/crm/refund/" />
...
defineOptions({ name: 'CrmRefundApproval' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await RefundApi.getRefundApprovalPage(queryParams)
...
const openDetail = (id: number) => {
  push({ name: 'CrmRefundApprovalDetail', params: { id } })
}
