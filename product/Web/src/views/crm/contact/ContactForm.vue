<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.name')" prop="name">
            <el-input v-model="formData.name" :placeholder="t('crm.contact.namePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.ownerUserId')" prop="ownerUserId">
            <el-select
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.mobile')" prop="mobile">
            <el-input v-model="formData.mobile" :placeholder="t('crm.contact.mobilePlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.telephone')" prop="telephone">
            <el-input v-model="formData.telephone" :placeholder="t('crm.contact.telephonePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.email')" prop="email">
            <el-input v-model="formData.email" :placeholder="t('crm.contact.emailPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.wechat')" prop="wechat">
            <el-input v-model="formData.wechat" :placeholder="t('crm.contact.wechatPlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.qq')" prop="qq">
            <el-input v-model="formData.qq" :placeholder="t('crm.contact.qqPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.post')" prop="post">
            <el-input v-model="formData.post" :placeholder="t('crm.contact.postPlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.master')" prop="master" style="width: 400px">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.areaId')" prop="areaId">
            <el-cascader
              ...
              clearable
              filterable
              :placeholder="t('crm.contact.areaPlaceholder')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.detailAddress')" prop="detailAddress">
            <el-input v-model="formData.detailAddress" :placeholder="t('crm.contact.detailAddressPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.contactNextTime')" prop="contactNextTime">
            <el-date-picker
              v-model="formData.contactNextTime"
              :placeholder="t('crm.contact.contactNextTimePlaceholder')"
              type="datetime"
              value-format="x"
              class="!w-1/1"
            />
        ...
        <el-col :span="12">
          <el-form-item :label="t('crm.contact.remark')" prop="remark">
            <el-input type="textarea" v-model="formData.remark" :placeholder="t('crm.contact.remarkPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
