...
<template>
  ...
  <el-card shadow="never" class="mt-16px">
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      ...
      <el-table-column :label="t('rank.productCount')" align="center" prop="count" min-width="200" />
    </el-table>
  </el-card>
</template>
...
const echartsOption = reactive<EChartsOption>({
  ...
  toolbox: {
    feature: {
      ...
      saveAsImage: { show: true, name: t('rank.productSales') } // 保存为图片
    }
  },
  tooltip: {
    trigger: 'axis',
