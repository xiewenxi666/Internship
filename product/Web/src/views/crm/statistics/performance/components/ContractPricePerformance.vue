...
const echartsOption = reactive<EChartsOption>({
  ...
  series: [
    {
      name: t('performance.currentMonthPrice'),
      type: 'line',
      data: []
    },
    {
      name: t('performance.lastMonthPrice'),
      type: 'line',
      data: []
    },
    {
      name: t('performance.lastYearPrice'),
      type: 'line',
      data: []
    },
    {
  ...
  toolbox: {
    feature: {
      ...
      saveAsImage: { show: true, name: t('performance.contractPrice') } // 保存为图片
      }
  },
  tooltip: {
    trigger: 'axis',
...
const tableData = reactive([
  { title: t('performance.currentMonthPrice') },
  { title: t('performance.lastMonthPrice') },
  { title: t('performance.lastYearPrice') },
