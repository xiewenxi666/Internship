...
<template>
  ...
  <el-col>
    <el-tabs v-model="activeTab">
      <!-- 客户总量分析 -->
      <el-tab-pane :label="t('customer.summary')" lazy name="customerSummary">
        <CustomerSummary ref="customerSummaryRef" :query-params="queryParams" />
      </el-tab-pane>
      <!-- 客户跟进次数分析 -->
      <el-tab-pane :label="t('customer.followUpSummary')" lazy name="followUpSummary">
        <CustomerFollowUpSummary ref="followUpSummaryRef" :query-params="queryParams" />
      </el-tab-pane>
      <!-- 客户跟进方式分析 -->
      <el-tab-pane :label="t('customer.followUpType')" lazy name="followUpType">
      ...
      <!-- 成交周期分析 -->
      <el-tab-pane :label="t('customer.dealCycleByUser')" lazy name="dealCycleByUser">
        <CustomerDealCycleByUser ref="dealCycleByUserRef" :query-params="queryParams" />
      </el-tab-pane>
      <el-tab-pane :label="t('customer.dealCycleByArea')" lazy name="dealCycleByArea">
        <CustomerDealCycleByArea ref="dealCycleByAreaRef" :query-params="queryParams" />
      </el-tab-pane>
      <el-tab-pane :label="t('customer.dealCycleByProduct')" lazy name="dealCycleByProduct">
