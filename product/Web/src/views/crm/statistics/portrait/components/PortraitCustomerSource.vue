...
<template>
  ...
  <el-card class="mt-16px" shadow="never">
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      ...
      <el-table-column align="center" :label="t('portrait.sourceName')" prop="source" min-width="100">
      ...
      <el-table-column align="center" :label="t('portrait.sourcePortion')" min-width="200" prop="sourcePortion" />
