...
<template>
  ...
  <el-card class="mt-16px" shadow="never">
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      ...
      <el-table-column align="center" :label="t('portrait.industryName')" prop="industryId" min-width="100">
      ...
      <el-table-column align="center" :label="t('portrait.industryPortion')" min-width="200" prop="industryPortion" />
