<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('pay.walletRechargePackage.name')" prop="name">
            <el-input v-model="formData.name" :placeholder="t('pay.walletRechargePackage.namePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('pay.walletRechargePackage.status')" prop="status">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('pay.walletRechargePackage.payPrice') + '(元)'" prop="payPrice">
            <el-input-number v-model="formData.payPrice" :min="0" :precision="2" :step="0.01" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('pay.walletRechargePackage.bonusPrice') + '(元)'" prop="bonusPrice">
