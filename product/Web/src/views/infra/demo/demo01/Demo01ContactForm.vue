<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('codegenDemo.birthday')" prop="birthday">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item :label="t('codegenDemo.avatar')" prop="avatar">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('codegenDemo.description')" prop="description">
...
const formRules = reactive({
  ...
  sex: [{ required: true, message: t('codegenDemo.sexRequired'), trigger: 'blur' }],
  birthday: [{ required: true, message: t('codegenDemo.birthdayRequired'), trigger: 'blur' }],
  description: [{ required: true, message: t('codegenDemo.descriptionRequired'), trigger: 'blur' }],
})
