<template>
  <ContentWrap>
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item :label="t('codegenDemo.sex')" prop="sex">
        <el-select
        ...
        <el-col :span="8">
          <el-form-item :label="t('codegenDemo.createTime')" prop="createTime">
        <el-date-picker
  ...
  <ContentWrap>
    <el-table
      ...
      <el-table-column :label="t('codegenDemo.id')" align="center" prop="id" />
      <el-table-column :label="t('codegenDemo.name')" align="center" prop="name" />
      <el-table-column :label="t('codegenDemo.sex')" align="center" prop="sex">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_USER_SEX" :value="scope.row.sex" />
        </template>
      </el-table-column>
      <el-table-column
        :label="t('codegenDemo.birthday')"
        align="center"
        prop="birthday"
        :formatter="dateFormatter"
        min-width="180"
       fixed="right" />
      <el-table-column :label="t('codegenDemo.description')" align="center" prop="description" />
      <el-table-column :label="t('codegenDemo.avatar')" align="center" prop="avatar" />
      <el-table-column
        :label="t('codegenDemo.createTime')"
        align="center"
        prop="createTime"
        :formatter="dateFormatter"
        min-width="180"
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('codegenDemo.demo01.exportFilename') + '.xls')
  } catch {
  } finally {
