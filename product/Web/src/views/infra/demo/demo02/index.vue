<template>
    ...
    >
      ...
      <el-row>
        ...
        <el-button type="danger" plain @click="toggleExpandAll">
          <Icon icon="ep:sort" class="mr-5px" /> {{ t('codegenDemo.demo02.toggleExpand') }}
        </el-button>
      </el-form-item>
        </el-col>
      </el-row>
  ...
  <ContentWrap>
    <el-table
        ...
        :table-layout="'auto'"
      >
      <el-table-column :label="t('codegenDemo.id')" align="center" prop="id"  fixed="right" />
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('codegenDemo.demo02.exportFilename') + '.xls')
  } catch {
  } finally {
