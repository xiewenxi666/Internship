<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('codegenDemo.demo03.courseName')" prop="name">
            <el-input v-model="formData.name" :placeholder="t('codegenDemo.demo03.courseNamePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('codegenDemo.demo03.score')" prop="score">
            <el-input v-model="formData.score" :placeholder="t('codegenDemo.demo03.scorePlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
