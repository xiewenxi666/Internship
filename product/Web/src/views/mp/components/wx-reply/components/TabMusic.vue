<template>
  <div>
    <el-row align="middle" justify="center">
          ...
          <el-col :span="24">
            ...
            <el-row align="middle" justify="center" style="margin-top: 2%">
              <div class="thumb-but">
                ...
                >
                  <template #trigger>
                    <el-button type="primary" link>{{ t('common.localUpload') }}</el-button>
                  </template>
      ...
      <el-col :span="18">
        <el-input v-model="reply.title" :placeholder="t('common.inputTitle')" />
        <div style="margin: 20px 0"></div>
        <el-input v-model="reply.description" :placeholder="t('common.inputDescription')" />
      </el-col>
    </el-row>
    <div style="margin: 20px 0"></div>
    <el-input v-model="reply.musicUrl" :placeholder="t('common.inputMusicUrl')" />
    <div style="margin: 20px 0"></div>
    <el-input v-model="reply.hqMusicUrl" :placeholder="t('common.inputHqMusicUrl')" />
  </div>
</template>
