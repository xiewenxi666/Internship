...
<template>
  <ContentWrap>
    <div class="msg-div" ref="msgDivRef">
      ...
      <div v-if="!loading">
        <div class="el-table__empty-block" v-if="hasMore" @click="loadMore"
          ><span class="el-table__empty-text">{{ t('common.clickLoadMore') }}</span></div
        >
        <div class="el-table__empty-block" v-if="!hasMore"
          ><span class="el-table__empty-text">{{ t('common.noMore') }}</span></div
        >
      </div>
    ...
    <div class="msg-send" v-loading="sendLoading">
      ...
      <el-button type="success" class="send-but" @click="sendMsg">{{ t('common.send') }}(S)</el-button>
    </div>
  </ContentWrap>
</template>
...
const sendMsg = async () => {
  ...
  if (
    ...
    message.success(t('common.articlesLimit'))
  }
