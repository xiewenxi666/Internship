package com.meession.etm.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "mitedtsm")
