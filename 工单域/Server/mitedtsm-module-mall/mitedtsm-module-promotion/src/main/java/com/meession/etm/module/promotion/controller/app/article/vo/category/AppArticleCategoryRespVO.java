package com.meession.etm.module.promotion.controller.app.article.vo.category;
...
public class AppArticleCategoryRespVO {
    ...
    @Schema(description = "分类图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
