package com.meession.etm.module.pay.service.order;
...
import com.meession.etm.module.pay.framework.pay.core.client.PayClient;
...
import com.meession.etm.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.meession.etm.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.meession.etm.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.meession.etm.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import com.meession.etm.module.pay.convert.order.PayOrderConvert;
import com.meession.etm.module.pay.dal.dataobject.app.PayAppDO;
import com.meession.etm.module.pay.dal.dataobject.channel.PayChannelDO;
import com.meession.etm.module.pay.dal.dataobject.order.PayOrderDO;
import com.meession.etm.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.meession.etm.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.meession.etm.module.pay.dal.mysql.order.PayOrderMapper;
import com.meession.etm.module.pay.dal.redis.no.PayNoRedisDAO;
import com.meession.etm.module.pay.enums.notify.PayNotifyTypeEnum;
import com.meession.etm.module.pay.enums.order.PayOrderStatusEnum;
import com.meession.etm.module.pay.framework.pay.config.PayProperties;
import com.meession.etm.module.pay.service.app.PayAppService;
import com.meession.etm.module.pay.service.channel.PayChannelService;
import com.meession.etm.module.pay.service.notify.PayNotifyService;
...
import static com.meession.etm.module.pay.enums.ErrorCodeConstants.*;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/mitedtsm-cloud/issues/I8SM9H 场景
