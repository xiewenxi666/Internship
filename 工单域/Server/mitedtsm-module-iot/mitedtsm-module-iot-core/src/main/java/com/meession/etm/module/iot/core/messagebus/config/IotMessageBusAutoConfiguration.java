package com.meession.etm.module.iot.core.messagebus.config;

import com.meession.etm.framework.mq.redis.core.RedisMQTemplate;
import com.meession.etm.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.meession.etm.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.meession.etm.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.meession.etm.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.meession.etm.module.iot.core.messagebus.core.IotMessageBus;
import com.meession.etm.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.meession.etm.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.meession.etm.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "mitedtsm.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "mitedtsm.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 MitedtsmRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.meession.etm.framework.mq.redis.config.MitedtsmRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "mitedtsm.iot.message-bus", name = "type", havingValue = "redis")
