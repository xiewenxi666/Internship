package com.meession.etm.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.meession.etm.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
