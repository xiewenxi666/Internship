package com.meession.etm.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${mitedtsm.websocket.sender-rocketmq.topic}",
        consumerGroup = "${mitedtsm.websocket.sender-rocketmq.consumer-group}",
