package com.meession.etm.framework.desensitize.core;

import com.meession.etm.framework.common.util.json.JsonUtils;
import com.meession.etm.framework.desensitize.core.annotation.Address;
import com.meession.etm.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.meession.etm.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.meession.etm.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("密讯");
        ...
        desensitizeDemo.setRegex("你好，我是密讯");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("密讯");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("密*", d.getNickname());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "密讯", replacer = "*")
