package com.meession.etm.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierRespVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
    @ExcelProperty("供应商名称")
    private String name;
