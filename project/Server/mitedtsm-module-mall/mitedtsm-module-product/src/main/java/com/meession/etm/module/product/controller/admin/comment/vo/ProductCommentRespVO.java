package com.meession.etm.module.product.controller.admin.comment.vo;
...
public class ProductCommentRespVO {
    ...
    @Schema(description = "评价人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
    ...
    @Schema(description = "商品 SKU 图片地址", example = "xxx")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED, example = "[xxx]")
