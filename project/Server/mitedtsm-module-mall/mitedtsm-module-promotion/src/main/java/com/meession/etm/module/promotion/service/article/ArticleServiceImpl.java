package com.meession.etm.module.promotion.service.article;

import cn.hutool.core.collection.CollUtil;
import com.meession.etm.framework.common.pojo.PageResult;
import com.meession.etm.module.promotion.controller.admin.article.vo.article.ArticleCreateReqVO;
import com.meession.etm.module.promotion.controller.admin.article.vo.article.ArticlePageReqVO;
import com.meession.etm.module.promotion.controller.admin.article.vo.article.ArticleUpdateReqVO;
import com.meession.etm.module.promotion.controller.app.article.vo.article.AppArticlePageReqVO;
import com.meession.etm.module.promotion.convert.article.ArticleConvert;
import com.meession.etm.module.promotion.dal.dataobject.article.ArticleCategoryDO;
import com.meession.etm.module.promotion.dal.dataobject.article.ArticleDO;
import com.meession.etm.module.promotion.dal.mysql.article.ArticleMapper;
...
import static com.meession.etm.module.promotion.enums.ErrorCodeConstants.ARTICLE_CATEGORY_NOT_EXISTS;
import static com.meession.etm.module.promotion.enums.ErrorCodeConstants.ARTICLE_NOT_EXISTS;
