...
import com.meession.etm.framework.web.core.filter.CacheRequestBodyFilter;
import com.meession.etm.framework.web.core.filter.DemoFilter;
import com.meession.etm.framework.web.core.handler.GlobalExceptionHandler;
import com.meession.etm.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class MitedtsmWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "mitedtsm.demo", havingValue = "true")
