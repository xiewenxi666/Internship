<template>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item>
            ...
            >
              <Icon icon="ep:delete" class="mr-5px" /> {{ t('system.tenant.batchDelete') }}
            </el-button>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('system.tenant.packageId')" align="center" prop="packageId">
      ...
      />
      <el-table-column :label="t('system.tenant.website')" align="center" prop="websites" min-width="180">
        <template #default="scope">
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('common.exportFilename.tenantList') + '.xls')
  } catch {
  } finally {
