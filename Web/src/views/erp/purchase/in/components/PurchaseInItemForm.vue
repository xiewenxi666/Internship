<template>
  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px" :table-layout="'auto'">
      ...
      <el-table-column :label="t('warehouseName')" min-width="125">
        <template #default="{ row, $index }">
          <el-form-item
            ...
            class="mb-0px!"
          >
            <el-select v-model="row.warehouseId" clearable filterable :placeholder="t('selectWarehouse')">
              <el-option
      ...
      <el-table-column :label="t('stock')" min-width="100">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('barCode')" min-width="150">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('unit')" min-width="80">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
      ...
      <el-table-column :label="t('count')" prop="count" fixed="right" min-width="140">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('productPrice')" fixed="right" min-width="120">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('amount')" prop="totalProductPrice" fixed="right" min-width="100">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('taxRate')" fixed="right" min-width="115">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('taxAmount')" prop="taxPrice" fixed="right" min-width="120">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('totalWithTax')" prop="totalPrice" fixed="right" min-width="100">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('remark')" min-width="150">
        <template #default="{ row, $index }">
          <el-form-item :prop="`${$index}.remark`" class="mb-0px!">
            <el-input v-model="row.remark" :placeholder="t('common.placeholder')" />
          </el-form-item>
        </template>
      </el-table-column>
