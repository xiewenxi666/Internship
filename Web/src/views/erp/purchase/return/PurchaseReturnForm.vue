  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1440">
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('no')" prop="no">
            <el-input disabled v-model="formData.no" :placeholder="t('common.autoGenerate')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
            ...
            <el-input v-model="formData.orderNo" readonly>
              <template #append>
                <el-button @click="openPurchaseOrderReturnEnableList">
                  <Icon icon="ep:search" /> {{ t('common.select') }}
                </el-button>
              </template>
            </el-input>
          </el-form-item>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('fileUrl')" prop="fileUrl">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('totalRefund')">
