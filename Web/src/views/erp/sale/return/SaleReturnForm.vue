  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1440">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('returnTime')" prop="returnTime">
            <el-date-picker
              v-model="formData.returnTime"
              type="date"
              value-format="x"
              :placeholder="t('selectReturnTime')"
              class="!w-1/1"
            />
          </el-form-item>
        </el-col>
            ...
            <el-input v-model="formData.orderNo" readonly>
              <template #append>
                <el-button @click="openSaleOrderReturnEnableList">
                  <Icon icon="ep:search" /> {{ t('selectOrder') }}
                </el-button>
              </template>
            </el-input>
          </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="24">
          <el-form-item :label="t('saleUser')" prop="saleUserId">
            <el-select
              v-model="formData.saleUserId"
              clearable
              filterable
              :placeholder="t('selectSaleUser')"
              class="!w-1/1"
            >
              <el-option
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('discountPercent')" prop="discountPercent">
            <el-input-number
        ...
        <el-col :span="12">
          <el-form-item :label="t('discountPrice')" prop="discountPrice">
            <el-input
              disabled
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('discountedPrice')">
            <el-input
              disabled
        ...
        <el-col :span="12">
          <el-form-item :label="t('otherPrice')" prop="otherPrice">
            <el-input-number
              v-model="formData.otherPrice"
              controls-position="right"
              :min="0"
              :precision="2"
              :placeholder="t('otherPrice')"
              class="!w-1/1"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('refundableAmount')" prop="totalPrice">
...
const { t } = useI18n('erp.sale.return') // 国际化
...
const formRules = reactive({
  ...
  returnTime: [{ required: true, message: t('returnTimeRequired'), trigger: 'blur' }]
})
