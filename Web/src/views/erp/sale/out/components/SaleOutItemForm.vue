<template>
  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px" :table-layout="'auto'">
      ...
      <el-table-column :label="t('taxPercent')" fixed="right" min-width="115">
        <template #default="{ row, $index }">
      ...
      <el-table-column :label="t('taxPrice')" prop="taxPrice" fixed="right" min-width="120">
        <template #default="{ row, $index }">
