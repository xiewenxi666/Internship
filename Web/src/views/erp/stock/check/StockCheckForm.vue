  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1080">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('checkTime')" prop="checkTime">
            <el-date-picker
              v-model="formData.checkTime"
              type="date"
              value-format="x"
              :placeholder="t('selectCheckTime')"
              class="!w-1/1"
            />
          </el-form-item>
        </el-col>
...
const { t } = useI18n('erp.stock.check') // 国际化
...
const formRules = reactive({
  checkTime: [{ required: true, message: t('checkTime') + t('common.required'), trigger: 'blur' }]
})
