<template>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('group.name')" prop="name">
            <el-input
              ...
              :placeholder="t('group.selectName')"
              clearable
        ...
        <el-col :span="8">
          <el-form-item :label="t('common.status')" prop="status">
            <el-select v-model="queryParams.status" :placeholder="t('group.selectStatus')" clearable class="!w-240px">
              <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      ...
      <el-table-column :label="t('group.description')" align="center" prop="description" />
      <el-table-column :label="t('group.member')" align="center">
