<template>
  ...
  <ContentWrap>
    ...
    >
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item :label="t('property.propertyItem')" prop="propertyId">
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      <el-table-column :label="t('property.valueId')" align="center" min-width="60" prop="id"  fixed="right" />
      <el-table-column :label="t('property.valueName')" align="center" min-width="150" prop="name" />
      <el-table-column :label="t('property.remark')" align="center" prop="remark" :show-overflow-tooltip="true" />
      <el-table-column
