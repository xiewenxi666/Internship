<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('property.propertyId')" prop="category">
            <el-input v-model="formData.propertyId" disabled="" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('property.name')" prop="name">
            <el-input v-model="formData.name" :placeholder="t('property.namePlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('property.remark')" prop="remark">
            <el-input v-model="formData.remark" :placeholder="t('property.remarkPlaceholder')" type="textarea" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
const formRules = reactive({
  propertyId: [{ required: true, message: t('property.propertyRequired'), trigger: 'blur' }],
