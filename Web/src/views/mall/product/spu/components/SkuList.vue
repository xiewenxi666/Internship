<template>
  ...
  <el-table
    ...
    size="small"
  >
    <el-table-column align="center" :label="t('sku.image')" min-width="65">
      <template #default="{ row }">
        <UploadImg v-model="row.picUrl" height="50px" min-width="50" />
      </template>
    </el-table-column>
    ...
    <el-table-column align="center" :label="t('sku.barCode')" min-width="168">
      <template #default="{ row }">
        <el-input v-model="row.barCode" class="w-100%" />
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('sku.price')" min-width="168">
      <template #default="{ row }">
        <el-input-number
          v-model="row.price"
          :min="0"
    ...
    <el-table-column align="center" :label="t('sku.marketPrice')" min-width="168">
      <template #default="{ row }">
        <el-input-number
    ...
    <el-table-column align="center" :label="t('sku.costPrice')" min-width="168">
      <template #default="{ row }">
        <el-input-number
    ...
    <el-table-column align="center" :label="t('sku.stock')" min-width="168">
      <template #default="{ row }">
        <el-input-number v-model="row.stock" :min="0" class="w-100%" controls-position="right" />
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('spu.weight')" min-width="168">
      <template #default="{ row }">
        <el-input-number
          v-model="row.weight"
          :min="0"
    ...
    <el-table-column align="center" :label="t('spu.volume')" min-width="168">
      <template #default="{ row }">
        <el-input-number
          v-model="row.volume"
          :min="0"
    ...
    <template v-if="formData!.subCommissionType">
      <el-table-column align="center" :label="t('sku.firstBrokeragePrice')" min-width="168">
        <template #default="{ row }">
          <el-input-number
      ...
      <el-table-column align="center" :label="t('sku.secondBrokeragePrice')" min-width="168">
        <template #default="{ row }">
          <el-input-number
  ...
  >
    ...
    <el-table-column align="center" :label="t('sku.image')" min-width="80">
      <template #default="{ row }">
        <el-image
          v-if="row.picUrl"
          :src="row.picUrl"
    ...
    <el-table-column align="center" :label="t('sku.barCode')" min-width="100">
      <template #default="{ row }">
        {{ row.barCode }}
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('sku.priceUnit')" min-width="80">
      <template #default="{ row }">
        {{ row.price }}
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('sku.marketPriceUnit')" min-width="80">
      <template #default="{ row }">
        {{ row.marketPrice }}
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('sku.costPriceUnit')" min-width="80">
      <template #default="{ row }">
        {{ row.costPrice }}
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('sku.stock')" min-width="80">
      <template #default="{ row }">
        {{ row.stock }}
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('spu.weight')" min-width="80">
      <template #default="{ row }">
        {{ row.weight }}
      </template>
    </el-table-column>
    <el-table-column align="center" :label="t('spu.volume')" min-width="80">
      <template #default="{ row }">
        {{ row.volume }}
      </template>
    </el-table-column>
    <template v-if="formData!.subCommissionType">
      <el-table-column align="center" :label="t('sku.firstBrokeragePrice')" min-width="80">
        <template #default="{ row }">
          {{ row.firstBrokeragePrice }}
        </template>
      </el-table-column>
      <el-table-column align="center" :label="t('sku.secondBrokeragePrice')" min-width="80">
        <template #default="{ row }">
...
const validateProperty = () => {
  ...
  const warningInfo = t('sku.propertyValueEmptyWarning')
...
const validateSku = () => {
  validateProperty()
  let warningInfo = t('sku.propertyCheckWarning')
