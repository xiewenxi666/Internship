  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="65%">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('activityTime')" prop="startAndEndTime">
            <el-date-picker
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('productScope')" prop="productScope">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('ruleSetting')">
...
const { t } = useI18n('mall.promotion.reward') // 国际化
...
const formRules = reactive({
  ...
  startAndEndTime: [{ required: true, message: t('activityTimeRequired'), trigger: 'blur' }],
  conditionType: [{ required: true, message: t('conditionTypeRequired'), trigger: 'change' }],
  productScope: [{ required: true, message: t('productScopeRequired'), trigger: 'blur' }],
  productSpuIds: [{ required: true, message: t('productSpuIdsRequired'), trigger: 'blur' }],
  productCategoryIds: [{ required: true, message: t('productCategoryIdsRequired'), trigger: 'blur' }]
})
