<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" :table-layout="'auto'">
      <el-table-column align="center" :label="t('title2')" prop="title" />
      <el-table-column align="center" :label="t('picUrl')" min-width="80" prop="picUrl">
      ...
      <el-table-column align="center" :label="t('position')" prop="position">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.PROMOTION_BANNER_POSITION" :value="scope.row.position" />
        </template>
      </el-table-column>
      <el-table-column align="center" :label="t('url')" prop="url"  fixed="right" />
      <el-table-column
