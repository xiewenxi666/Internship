...
const templateItems = reactive([
  { name: t('template.basicSetting'), icon: 'ep:iphone' },
  { name: t('template.homePage'), icon: 'ep:home-filled' },
  { name: t('template.myPage'), icon: 'ep:user-filled' }
])
...
onMounted(async () => {
  ...
  if (!currentRoute.value.params.id) {
    message.warning(t('template.paramError'))
