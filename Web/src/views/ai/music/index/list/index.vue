  ...
  <div class="flex flex-col h-full">
    <div class="flex-auto flex overflow-hidden">
      <el-tabs v-model="currentType" class="flex-auto px-[var(--app-content-padding)]">
        <!-- 我的创作 -->
        <el-tab-pane v-loading="loading" :label="t('music.myCreations')" name="mine">
          ...
          <el-empty v-else :description="t('music.noMusic')"/>
        </el-tab-pane>

        <!-- 试听广场 -->
        <el-tab-pane v-loading="loading" :label="t('music.listeningSquare')" name="square">
