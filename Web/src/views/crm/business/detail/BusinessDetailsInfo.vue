    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item name="basicInfo">
        ...
        <el-descriptions :column="4">
          ...
          <el-descriptions-item :label="t('crm.business.contactId')">{{ business.contactName || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item :label="t('crm.business.type')">
            {{ business.type || '-' }}
          </el-descriptions-item>
          <el-descriptions-item :label="t('crm.business.probability')">
            {{ business.probability != null ? business.probability + '%' : '-' }}
          </el-descriptions-item>
          <el-descriptions-item :label="t('crm.business.source')">
            {{ business.source || '-' }}
          </el-descriptions-item>
      ...
      <el-collapse-item name="systemInfo">
        ...
        <el-descriptions :column="4">
          ...
          <el-descriptions-item :label="t('crm.business.ownerUserDeptName')">{{ business.ownerUserDept }}</el-descriptions-item>
