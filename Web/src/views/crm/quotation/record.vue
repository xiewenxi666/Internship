      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-form-item label="状态" prop="status">
            <el-select v-model="queryParams.status" clearable placeholder="选择状态" class="!w-240px">
...
defineOptions({ name: 'CrmQuotationRecord' })
...
/** 时间范围变化 */
const handleCreateTimeRangeChange = (val: string[]) => {
  if (val && val.length === 2) {
...
onMounted(() => {
  if (query.businessId) {
    queryParams.businessId = Number(query.businessId)
  }
  getList()
})
</script>
