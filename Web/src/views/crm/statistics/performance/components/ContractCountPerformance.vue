...
const echartsOption = reactive<EChartsOption>({
  ...
  series: [
    {
      name: t('performance.currentMonthCount'),
      type: 'line',
      data: []
    },
    {
      name: t('performance.lastMonthCount'),
      type: 'line',
      data: []
    },
    {
      name: t('performance.lastYearCount'),
      type: 'line',
      data: []
    },
    {
  ...
  toolbox: {
    feature: {
      ...
      saveAsImage: { show: true, name: t('performance.contractCount') } // 保存为图片
    }
  },
  tooltip: {
    trigger: 'axis',
