...
<template>
  ...
  <el-card shadow="never" class="mt-16px">
    <el-table v-loading="loading" :data="list" :table-layout="'auto'">
      <el-table-column :label="t('rank.index')" align="center" type="index" width="80" />
      <el-table-column :label="t('rank.nickname')" align="center" prop="nickname" min-width="200" />
      <el-table-column :label="t('rank.deptName')" align="center" prop="deptName" min-width="200" />
      <el-table-column :label="t('rank.followCustomerCount2')" align="center" prop="count" min-width="200" />
    </el-table>
  </el-card>
</template>
...
const echartsOption = reactive<EChartsOption>({
  ...
  series: [
    {
      name: t('rank.followCustomerCountRank'),
      type: 'bar'
    }
  ],
  toolbox: {
    feature: {
      ...
      saveAsImage: { show: true, name: t('rank.followCustomerCount') } // 保存为图片
    }
  },
  tooltip: {
    trigger: 'axis',
  ...
  xAxis: {
    type: 'value',
    name: t('rank.followCustomerCount2')
  },
  yAxis: {
    type: 'category',
    name: t('rank.nickname')
  }
}) as EChartsOption
