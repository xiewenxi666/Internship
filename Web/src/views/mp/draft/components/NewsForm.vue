  ...
  <el-container>
    ...
    <el-main>
      <div v-if="newsList.length > 0">
        <!-- 标题、作者、原文地址 -->
        <el-row :gutter="20">
          <el-input v-model="activeNewsItem.title" :placeholder="t('draft.titlePlaceholder')" />
          <el-input
            v-model="activeNewsItem.author"
            :placeholder="t('draft.authorPlaceholder')"
            style="margin-top: 5px"
          />
          <el-input
            v-model="activeNewsItem.contentSourceUrl"
            :placeholder="t('draft.sourceUrlPlaceholder')"
            style="margin-top: 5px"
          />
        </el-row>
        <!-- 封面和摘要 -->
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            ...
            <el-input
              ...
              :placeholder="t('draft.digestPlaceholder')"
              class="digest"
              maxlength="120"
            />
          </el-col>
...
const removeNews = async (index: number) => {
  try {
    await message.confirm(t('draft.confirmDeleteNews'))
