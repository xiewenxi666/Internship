  ...
  <div>
    ...
    <div class="thumb-div">
      ...
      <div class="thumb-but">
        ...
        >
          <template #trigger>
            <el-button size="small" type="primary">{{ t('draft.localUpload') }}</el-button>
          </template>
          <el-button
            size="small"
            type="primary"
          ...
          <template #tip>
            <div class="el-upload__tip">{{ t('material.imageTip') }}</div>
          </template>
        </el-upload>
      </div>
      <el-dialog
...
const onUploadError = (err: Error) => {
  message.error(t('common.uploadFailed') + err.message)
}
</script>
