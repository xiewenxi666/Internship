        ...
        <el-row style="text-align: center" align="middle">
          <el-col :span="24">
            <el-button type="success" @click="showDialog = true">
              {{ newsType === NewsType.Published ? t('common.selectPublishedNews') : t('common.selectDraftNews') }}
              <Icon icon="ep:circle-check" />
            </el-button>
          </el-col>
        </el-row>
      </el-col>
      <el-dialog :title="t('common.selectNews')" v-model="showDialog" width="90%" append-to-body destroy-on-close>
        <WxMaterialSelect
          type="news"
