<template>
  <ContentWrap v-loading="formLoading">
    <el-tabs v-model="activeName">
      <el-tab-pane :label="t('codegen.tab.basicInfo')" name="basicInfo">
        <basic-info-form ref="basicInfoRef" :table="formData.table" />
      </el-tab-pane>
      <el-tab-pane :label="t('codegen.tab.fieldInfo')" name="colum">
        <colum-info-form ref="columInfoRef" :columns="formData.columns" />
      </el-tab-pane>
      <el-tab-pane :label="t('codegen.tab.generateInfo')" name="generateInfo">
        <generate-info-form
          ref="generateInfoRef"
