<template>
        ...
        <el-col :span="8">
          <el-form-item :label="t('device.group.name')" prop="name">
            <el-input
              ...
              :placeholder="t('device.group.namePlaceholder')"
              clearable
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" :table-layout="'auto'">
      <el-table-column :label="t('device.group.id')" align="center" prop="id" />
      <el-table-column :label="t('device.group.name')" align="center" prop="name" />
      <el-table-column :label="t('device.group.status')" align="center" prop="status">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.COMMON_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column :label="t('device.group.description')" align="center" prop="description"  fixed="right" />
      <el-table-column
