<template>
        ...
        <el-col :span="8">
          <el-form-item :label="t('common.productName')" prop="name">
            <el-input
              ...
              class="!w-240px"
              clearable
              :placeholder="t('common.inputProductName')"
  ...
  <ContentWrap>
            ...
            <div class="flex items-center text-[14px]">
              <div class="flex-1">
                <div class="mb-2.5 last:mb-0">
                  <span class="text-[#717c8e] mr-2.5">{{ t('common.productCategory') }}</span>
                  <span class="text-[#0070ff]">{{ item.categoryName }}</span>
                </div>
                <div class="mb-2.5 last:mb-0">
                  <span class="text-[#717c8e] mr-2.5">{{ t('common.productType') }}</span>
    ...
    <el-table v-else v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" :table-layout="'auto'">
      ...
      <el-table-column align="center" :label="t('common.deviceType')" prop="deviceType">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.IOT_PRODUCT_DEVICE_TYPE" :value="scope.row.deviceType" />
        </template>
      </el-table-column>
      <el-table-column align="center" :label="t('common.productIcon')" prop="icon">
        <template #default="scope">
          <el-image
            v-if="scope.row.icon"
      ...
      <el-table-column align="center" :label="t('common.productPicture')" prop="picture">
        <template #default="scope">
          <el-image
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('common.exportProduct') + '.xls')
  } catch {
  } finally {
