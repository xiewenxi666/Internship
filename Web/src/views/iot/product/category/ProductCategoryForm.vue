      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="t('category.sort')" prop="sort">
            <el-input v-model="formData.sort" :placeholder="t('category.sortPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item :label="t('category.description')" prop="description">
            <el-input type="textarea" v-model="formData.description" :placeholder="t('category.descriptionPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
