<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" :table-layout="'auto'">
      <el-table-column :label="t('category.id')" align="center" prop="id" />
      <el-table-column :label="t('category.name')" align="center" prop="name" />
      <el-table-column :label="t('category.sort')" align="center" prop="sort" />
      <el-table-column :label="t('category.status')" align="center" prop="status">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.COMMON_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column :label="t('category.description')" align="center" prop="description"  fixed="right" />
      <el-table-column
