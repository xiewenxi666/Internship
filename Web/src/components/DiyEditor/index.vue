<template>
  <el-container class="editor">
    ...
    <el-header class="editor-header">
      ...
      <el-button-group class="header-right">
        <el-tooltip :content="t('editor.toolbar.reset')">
          <el-button @click="handleReset">
            <Icon :size="24" icon="system-uicons:reset-alt" />
          </el-button>
        </el-tooltip>
        <el-tooltip v-if="previewUrl" :content="t('editor.toolbar.preview')">
          <el-button @click="handlePreview">
            <Icon :size="24" icon="ep:view" />
          </el-button>
        </el-tooltip>
        <el-tooltip :content="t('editor.toolbar.save')">
  ...
  <!-- 预览弹框 -->
  <Dialog v-model="previewDialogVisible" :title="t('editor.preview.title')" width="700">
    <div class="flex justify-around">
      ...
      <div class="flex flex-col">
        <el-text>{{ t('editor.preview.scanQrCode') }}</el-text>
...
watch(
  ...
  (val: any) => {
    ...
    // https://gitee.com/mitedtsmcode/mitedtsm-ui-admin-vue3/pulls/792
    if (props.showTabBar) {
