<template>
  ...
  >
    ...
    <el-tabs type="border-card" v-model="activeTabName">
      <el-tab-pane :label="t('simpleDesigner.copy')" name="user">
        <div>
          <el-form ref="formRef" :model="configForm" label-position="top" :rules="formRules">
            <el-form-item :label="t('simpleDesigner.configureCopyPerson')" prop="candidateStrategy">
              <el-radio-group
...
const formRules = reactive({
  candidateStrategy: [{ required: true, message: t('simpleDesigner.configureCopyPerson'), trigger: 'change' }],
