    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          noCache: true,
          hidden: true,
          activeMenu: '/crm/business-manage/list'
        },
      ...
      },
      {
        ...
        name: 'CrmBusinessForecast',
        meta: {
          title: t('router.crmBusinessForecast'),
          noCache: true,
          hidden: true,
          activeMenu: '/crm/business'
        },
        component: () => import('@/views/crm/business/forecast/index.vue')
      },
      {
        path: 'business/report',
        name: 'CrmBusinessReport',
        meta: {
          title: t('router.crmBusinessReport'),
          noCache: true,
          hidden: true,
          activeMenu: '/crm/business'
        },
        component: () => import('@/views/crm/business/report/index.vue')
      },
      {
        path: 'quotation/confirm',
        name: 'CrmQuotationConfirm',
        meta: {
          title: t('router.crmQuotationConfirm'),
          noCache: true,
          hidden: true,
          activeMenu: '/crm/quotation'
        },
        component: () => import('@/views/crm/quotation/confirm/index.vue')
      },
      {
        path: 'quotation/record',
        name: 'CrmQuotationRecord',
        meta: {
          title: t('router.crmQuotationRecord'),
          noCache: true,
          hidden: true,
          activeMenu: '/crm/quotation'
        },
        component: () => import('@/views/crm/quotation/record.vue')
      }
    ]
  },
  {
