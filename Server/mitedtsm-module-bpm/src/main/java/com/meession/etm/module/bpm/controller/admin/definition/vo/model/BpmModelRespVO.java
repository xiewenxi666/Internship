package com.meession.etm.module.bpm.controller.admin.definition.vo.model;

import com.meession.etm.module.bpm.controller.admin.base.dept.DeptSimpleBaseVO;
...
public class BpmModelRespVO extends BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_mitedtsm")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
    private String name;

    @Schema(description = "流程图标", example = "xxx")
    private String icon;
