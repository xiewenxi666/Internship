package com.meession.etm.module.pay.framework.pay.core.client.impl.wallet;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.meession.etm.framework.common.exception.ServiceException;
import com.meession.etm.module.pay.enums.PayChannelEnum;
import com.meession.etm.module.pay.enums.refund.PayRefundStatusEnum;
import com.meession.etm.module.pay.enums.transfer.PayTransferStatusEnum;
import com.meession.etm.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.meession.etm.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.meession.etm.module.pay.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import com.meession.etm.module.pay.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.meession.etm.module.pay.framework.pay.core.client.dto.transfer.PayTransferRespDTO;
import com.meession.etm.module.pay.framework.pay.core.client.dto.transfer.PayTransferUnifiedReqDTO;
import com.meession.etm.module.pay.framework.pay.core.client.impl.AbstractPayClient;
import com.meession.etm.module.pay.framework.pay.core.client.impl.NonePayClientConfig;
import com.meession.etm.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.meession.etm.module.pay.dal.dataobject.refund.PayRefundDO;
import com.meession.etm.module.pay.dal.dataobject.transfer.PayTransferDO;
import com.meession.etm.module.pay.dal.dataobject.wallet.PayWalletTransactionDO;
import com.meession.etm.module.pay.enums.order.PayOrderStatusEnum;
import com.meession.etm.module.pay.enums.wallet.PayWalletBizTypeEnum;
import com.meession.etm.module.pay.service.order.PayOrderService;
import com.meession.etm.module.pay.service.refund.PayRefundService;
import com.meession.etm.module.pay.service.transfer.PayTransferService;
import com.meession.etm.module.pay.service.wallet.PayWalletService;
import com.meession.etm.module.pay.service.wallet.PayWalletTransactionService;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.meession.etm.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.meession.etm.module.pay.enums.ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND;
import static com.meession.etm.module.pay.enums.ErrorCodeConstants.REFUND_NOT_FOUND;
