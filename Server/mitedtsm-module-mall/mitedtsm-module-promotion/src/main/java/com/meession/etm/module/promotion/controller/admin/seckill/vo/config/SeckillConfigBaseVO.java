package com.meession.etm.module.promotion.controller.admin.seckill.vo.config;
...
public class SeckillConfigBaseVO {
    ...
    @Schema(description = "秒杀轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[xxx]")
