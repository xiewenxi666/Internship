package com.meession.etm.module.promotion.controller.admin.bargain.vo.activity;
...
public class BargainActivityPageItemRespVO extends BargainActivityBaseVO {
    ...
    @Schema(description = "商品主图", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
