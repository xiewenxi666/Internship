package com.meession.etm.module.trade.service.brokerage;
...
import com.meession.etm.module.product.api.sku.ProductSkuApi;
import com.meession.etm.module.product.api.sku.dto.ProductSkuRespDTO;
import com.meession.etm.module.product.api.spu.ProductSpuApi;
import com.meession.etm.module.product.api.spu.dto.ProductSpuRespDTO;
import com.meession.etm.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.meession.etm.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.meession.etm.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import com.meession.etm.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.meession.etm.module.trade.convert.brokerage.BrokerageRecordConvert;
import com.meession.etm.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import com.meession.etm.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import com.meession.etm.module.trade.dal.dataobject.config.TradeConfigDO;
import com.meession.etm.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import com.meession.etm.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import com.meession.etm.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
import com.meession.etm.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import com.meession.etm.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import com.meession.etm.module.trade.service.config.TradeConfigService;
...
import static com.meession.etm.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.meession.etm.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.meession.etm.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.meession.etm.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
