...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.meession.etm";
    private static final String ARTIFACT_ID = "mitedtsm";
    private static final String PACKAGE_NAME = "com.meession.etm";
    private static final String TITLE = "mitedtsm管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.meession.etm";
        String artifactIdNew = "mitedtsm";
        String packageNameNew = "com.meession.etm";
        String titleNew = "mitedtsm管理系统";
