package com.meession.etm.module.ai.controller.admin.knowledge.vo.knowledge;
...
public class AiKnowledgeDocumentCreateReqVO {
    ...
    @Schema(description = "文档 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "xxx")
