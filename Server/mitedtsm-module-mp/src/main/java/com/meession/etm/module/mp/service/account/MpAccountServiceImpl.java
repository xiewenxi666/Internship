package com.meession.etm.module.mp.service.account;
...
import com.meession.etm.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.meession.etm.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.meession.etm.module.mp.convert.account.MpAccountConvert;
import com.meession.etm.module.mp.dal.dataobject.account.MpAccountDO;
import com.meession.etm.module.mp.dal.mysql.account.MpAccountMapper;
import com.meession.etm.module.mp.enums.ErrorCodeConstants;
...
import static com.meession.etm.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 mitedtsm-module-mp - 表结构未导入][参考 xxx/mp/build/ 开启]");
            }
