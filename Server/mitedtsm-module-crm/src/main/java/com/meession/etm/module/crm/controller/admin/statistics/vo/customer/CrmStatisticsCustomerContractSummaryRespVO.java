...
public class CrmStatisticsCustomerContractSummaryRespVO {
    ...
    @Schema(description = "客户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
    ...
    @Schema(description = "负责人", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
