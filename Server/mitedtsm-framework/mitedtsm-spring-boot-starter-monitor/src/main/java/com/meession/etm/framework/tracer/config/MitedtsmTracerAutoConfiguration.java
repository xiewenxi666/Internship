package com.meession.etm.framework.tracer.config;

import com.meession.etm.framework.common.enums.WebFilterOrderEnum;
import com.meession.etm.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "mitedtsm.tracer", value = "enable", matchIfMissing = true)
public class MitedtsmTracerAutoConfiguration {
