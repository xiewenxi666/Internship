package com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.meession.etm.module.iot.core.biz.dto.IotDeviceRespDTO;
import com.meession.etm.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import com.meession.etm.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.meession.etm.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.meession.etm.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
...
import com.meession.etm.module.iot.core.util.IotDeviceAuthUtils;
import com.meession.etm.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.meession.etm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.meession.etm.module.iot.gateway.service.device.IotDeviceService;
import com.meession.etm.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.meession.etm.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.meession.etm.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
