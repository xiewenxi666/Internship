package com.meession.etm.module.iot.service.rule.action.databridge;
...
import com.meession.etm.module.iot.dal.dataobject.rule.config.*;
import com.meession.etm.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("xxx/").setMethod(HttpMethod.GET.name());
