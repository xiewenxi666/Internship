package com.meession.etm.module.system.service.social;
...
import com.meession.etm.framework.common.util.cache.CacheUtils;
import com.meession.etm.framework.common.util.http.HttpUtils;
import com.meession.etm.framework.common.util.object.BeanUtils;
import com.meession.etm.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.meession.etm.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.meession.etm.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.meession.etm.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.meession.etm.module.system.dal.dataobject.social.SocialClientDO;
import com.meession.etm.module.system.dal.mysql.social.SocialClientMapper;
...
import com.meession.etm.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.meession.etm.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.meession.etm.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${mitedtsm.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${mitedtsm.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/mitedtsm-cloud/pulls/230
