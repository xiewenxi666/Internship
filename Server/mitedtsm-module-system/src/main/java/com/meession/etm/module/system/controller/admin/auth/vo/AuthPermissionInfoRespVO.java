package com.meession.etm.module.system.controller.admin.auth.vo;
...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "密讯")
        private Long id;
